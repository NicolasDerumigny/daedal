...
@"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_vi" = external global i64
@"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_lsup" = external global i64
@"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_granularity" = external global i64
...
; <label>:18                                      ; preds = %21, %11
  %19 = call i64 @list_iter_hasNext(%struct.list_node** %it, %struct.list* %4) #8
  %20 = icmp ne i64 %19, 0
...
; <label>:91                                      ; preds = %119, %82
  %92 = call i64 @list_iter_hasNext(%struct.list_node** %it, %struct.list* %6) #8
  %93 = icmp ne i64 %92, 0
...
; <label>:119                                     ; preds = %._crit_edge1, %118
  br label %91
...
; <label>:32                                      ; preds = %86, %26
  %33 = call i64 @TMlist_iter_hasNext(%struct.list_node** %it, %struct.list* %31) #8
  %34 = icmp ne i64 %33, 0
...
; <label>:35                                      ; preds = %32
  ...
  %40 = call i8* @list_find(%struct.list* %6, i8* %39) #8
...
; <label>:42                                      ; preds = %35
  %43 = call i64 @element_isInCircumCircle(%struct.element* %37, %struct.coordinate* %centerCoordinate) #8
  %44 = icmp ne i64 %43, 0
...
; <label>:59                                      ; preds = %42
  %60 = call %struct.pair* @element_getCommonEdge(%struct.element* %37, %struct.element* %28) #8
...
; <label>:82                                      ; preds = %._crit_edge8, %81
  %success1.0 = phi i64 [ 1, %81 ], [ 0, %._crit_edge8 ]
  br label %83

; <label>:83                                      ; preds = %._crit_edge7, %82
  %success1.1 = phi i64 [ %success1.0, %82 ], [ 0, %._crit_edge7 ]
  br label %84

; <label>:84                                      ; preds = %._crit_edge6, %83
  br label %85
...
define void @TMregion_transferBad(%struct.region* %regionPtr, %struct.heap* %workHeapPtr) #0 {
  ...
  br label %__kernel__TMregion_transferBad0_outer_chunking

__kernel__TMregion_transferBad0_outer_chunking:   ; preds = %0, %__kernel__TMregion_transferBad0_exitChunk
  %i.0 = phi i64 [ 0, %0 ], [ %i.1, %__kernel__TMregion_transferBad0_exitChunk ]
  %lsup_value = load i64, i64* @"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_lsup"
  store i64 %lsup_value, i64* @"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_vi"
  %granularity_value = load i64, i64* @"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_granularity"
  %new_lsup = add i64 %lsup_value, %granularity_value
  store i64 %new_lsup, i64* @"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_lsup"
  %outer_vi = load i64, i64* @"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_vi"
  br label %__kernel____kernel__TMregion_transferBad0_viCond

__kernel____kernel__TMregion_transferBad0_viCond: ; preds = %__kernel__TMregion_transferBad0_outer_chunking, %20
  %i.1 = phi i64 [ %i.0, %__kernel__TMregion_transferBad0_outer_chunking ], [ %21, %20 ]
  %vi_value = phi i64 [ %outer_vi, %__kernel__TMregion_transferBad0_outer_chunking ], [ %"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_vi_inc", %20 ]
  %lsup_value1 = load i64, i64* @"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_lsup"
  %"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_vi_cmp" = icmp slt i64 %vi_value, %lsup_value1
  br i1 %"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_vi_cmp", label %__kernel__TMregion_transferBad0, label %__kernel__TMregion_transferBad0_exitChunk

__kernel__TMregion_transferBad0_exitChunk:        ; preds = %__kernel____kernel__TMregion_transferBad0_viCond
  br label %__kernel__TMregion_transferBad0_outer_chunking

__kernel__TMregion_transferBad0:                  ; preds = %__kernel____kernel__TMregion_transferBad0_viCond
  %4 = icmp slt i64 %i.1, %3
  br i1 %4, label %5, label %22

; <label>:5                                       ; preds = %__kernel__TMregion_transferBad0
  %6 = call i8* @vector_at(%struct.vector* %2, i64 %i.1)
  %7 = bitcast i8* %6 to %struct.element*
  %8 = call i64 @TMelement_isGarbage(%struct.element* %7)
  %9 = icmp ne i64 %8, 0
  br i1 %9, label %10, label %11
...
; <label>:11                                      ; preds = %5
  %12 = bitcast %struct.element* %7 to i8*
  %13 = call i64 @TMheap_insert(%struct.heap* %workHeapPtr, i8* %12)
  %14 = icmp ne i64 %13, 0
...
; <label>:20                                      ; preds = %19
  %21 = add nsw i64 %i.1, 1
  %"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_vi_inc" = add i64 %vi_value, 1
  store i64 %"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_vi_inc", i64* @"../bin/region.marked.ll_TMregion_transferBad___kernel__TMregion_transferBad0_vi"
  br label %__kernel____kernel__TMregion_transferBad0_viCond, !llvm.loop !2

; <label>:22                                      ; preds = %__kernel__TMregion_transferBad0
  ret void
}
