...
; <label>:8                                       ; preds = %33, %0
  ...
  %10 = load i64, i64* %numBad, align 8
  %11 = icmp slt i64 %9, %10
  br i1 %11, label %12, label %36

; <label>:12                                      ; preds = %8
  %13 = load %struct.vector*, %struct.vector** %badVectorPtr, align 8
  %14 = load i64, i64* %i, align 8
  %15 = call i8* @vector_at(%struct.vector* %13, i64 %14)
  %16 = bitcast i8* %15 to %struct.element*
  store %struct.element* %16, %struct.element** %badElementPtr, align 8
  %17 = load %struct.element*, %struct.element** %badElementPtr, align 8
  %18 = call i64 @TMelement_isGarbage(%struct.element* %17)
  %19 = icmp ne i64 %18, 0
...
; <label>:21                                      ; preds = %12
  %22 = load %struct.heap*, %struct.heap** %2, align 8
  %23 = load %struct.element*, %struct.element** %badElementPtr, align 8
  %24 = bitcast %struct.element* %23 to i8*
  %25 = call i64 @TMheap_insert(%struct.heap* %22, i8* %24)
