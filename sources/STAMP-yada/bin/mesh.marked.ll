...
__kernel__TMmesh_insert0:                         ; preds = %142, %22
  %25 = load i64, i64* %i, align 8
  %26 = load i64, i64* %numEdge, align 8
  %27 = icmp slt i64 %25, %26
  br i1 %27, label %28, label %145

; <label>:28                                      ; preds = %__kernel__TMmesh_insert0
  %29 = load %struct.element*, %struct.element** %2, align 8
  %30 = load i64, i64* %i, align 8
  %31 = call %struct.pair* @element_getEdge(%struct.element* %29, i64 %30)
  store %struct.pair* %31, %struct.pair** %edgePtr, align 8
  store i64 0, i64* %success, align 8
  %32 = load %struct.pair*, %struct.pair** %edgePtr, align 8
  %33 = bitcast %struct.pair* %32 to i8*
  %34 = getelementptr inbounds %struct.pair, %struct.pair* %searchPair, i32 0, i32 0
  store i8* %33, i8** %34, align 8
  %35 = load %struct.jsw_avltree*, %struct.jsw_avltree** %3, align 8
  %36 = bitcast %struct.pair* %searchPair to i8*
  %37 = call i8* @jsw_avlfind(%struct.jsw_avltree* %35, i8* %36)
...
; <label>:44                                      ; preds = %40
  ...
  %46 = bitcast %struct.pair* %45 to i8*
  %47 = load %struct.element*, %struct.element** %2, align 8
  %48 = bitcast %struct.element* %47 to i8*
  %49 = call %struct.pair* @Ppair_alloc(i8* %46, i8* %48)
  store %struct.pair* %49, %struct.pair** %insertPtr, align 8
  %50 = load %struct.pair*, %struct.pair** %insertPtr, align 8
  %51 = icmp ne %struct.pair* %50, null
  br i1 %51, label %52, label %60

; <label>:52                                      ; preds = %44
  %53 = load %struct.jsw_avltree*, %struct.jsw_avltree** %3, align 8
  %54 = load %struct.pair*, %struct.pair** %insertPtr, align 8
  %55 = bitcast %struct.pair* %54 to i8*
  %56 = call i64 @Pjsw_avlinsert(%struct.jsw_avltree* %53, i8* %55)
  %57 = icmp ne i64 %56, 0
...
; <label>:60                                      ; preds = %59, %44
  %61 = load i64, i64* %success1, align 8
  store i64 %61, i64* %6, align 8
  %62 = load i64, i64* %6, align 8
  store i64 %62, i64* %isSuccess, align 8
  %63 = load i64, i64* %isSuccess, align 8
  %64 = icmp ne i64 %63, 0
...
; <label>:69                                      ; preds = %40
  store i8* null, i8** %dataPtr, align 8
  %70 = load %struct.pair*, %struct.pair** %edgePtr, align 8
  %71 = bitcast %struct.pair* %70 to i8*
  %72 = getelementptr inbounds %struct.pair, %struct.pair* %searchPair3, i32 0, i32 0
  store i8* %71, i8** %72, align 8
  %73 = load %struct.jsw_avltree*, %struct.jsw_avltree** %3, align 8
  %74 = bitcast %struct.pair* %searchPair3 to i8*
  %75 = call i8* @jsw_avlfind(%struct.jsw_avltree* %73, i8* %74)
  %76 = bitcast i8* %75 to %struct.pair*
  store %struct.pair* %76, %struct.pair** %pairPtr, align 8
  %77 = load %struct.pair*, %struct.pair** %pairPtr, align 8
  %78 = icmp ne %struct.pair* %77, null
  br i1 %78, label %79, label %83

; <label>:79                                      ; preds = %69
  %80 = load %struct.pair*, %struct.pair** %pairPtr, align 8
  %81 = getelementptr inbounds %struct.pair, %struct.pair* %80, i32 0, i32 1
  %82 = load i8*, i8** %81, align 8
  store i8* %82, i8** %dataPtr, align 8
  br label %83

; <label>:83                                      ; preds = %79, %69
  %84 = load i8*, i8** %dataPtr, align 8
  store i8* %84, i8** %7, align 8
  %85 = load i8*, i8** %7, align 8
  %86 = bitcast i8* %85 to %struct.element*
  store %struct.element* %86, %struct.element** %sharerPtr, align 8
  %87 = load %struct.element*, %struct.element** %sharerPtr, align 8
  %88 = icmp ne %struct.element* %87, null
...
; <label>:92                                      ; preds = %91, %89
  %93 = load %struct.element*, %struct.element** %2, align 8
  %94 = load %struct.element*, %struct.element** %sharerPtr, align 8
  call void @TMelement_addNeighbor(%struct.element* %93, %struct.element* %94)
  %95 = load %struct.element*, %struct.element** %sharerPtr, align 8
  %96 = load %struct.element*, %struct.element** %2, align 8
  call void @TMelement_addNeighbor(%struct.element* %95, %struct.element* %96)
  store i64 0, i64* %success4, align 8
  %97 = load %struct.pair*, %struct.pair** %edgePtr, align 8
  %98 = bitcast %struct.pair* %97 to i8*
  %99 = getelementptr inbounds %struct.pair, %struct.pair* %searchPair5, i32 0, i32 0
  store i8* %98, i8** %99, align 8
  %100 = load %struct.jsw_avltree*, %struct.jsw_avltree** %3, align 8
  %101 = bitcast %struct.pair* %searchPair5 to i8*
  %102 = call i8* @jsw_avlfind(%struct.jsw_avltree* %100, i8* %101)
  %103 = bitcast i8* %102 to %struct.pair*
  store %struct.pair* %103, %struct.pair** %pairPtr6, align 8
  %104 = load %struct.jsw_avltree*, %struct.jsw_avltree** %3, align 8
  %105 = bitcast %struct.pair* %searchPair5 to i8*
  %106 = call i64 @Pjsw_avlerase(%struct.jsw_avltree* %104, i8* %105)
  %107 = icmp ne i64 %106, 0
  br i1 %107, label %108, label %110

; <label>:108                                     ; preds = %92
  %109 = load %struct.pair*, %struct.pair** %pairPtr6, align 8
  call void @Ppair_free(%struct.pair* %109)
  store i64 1, i64* %success4, align 8
  br label %110

; <label>:110                                     ; preds = %108, %92
  %111 = load i64, i64* %success4, align 8
  store i64 %111, i64* %8, align 8
  %112 = load i64, i64* %8, align 8
  store i64 %112, i64* %isSuccess2, align 8
  %113 = load i64, i64* %isSuccess2, align 8
...
; <label>:118                                     ; preds = %117, %115
  store i64 0, i64* %success7, align 8
  %119 = load %struct.pair*, %struct.pair** %edgePtr, align 8
  %120 = bitcast %struct.pair* %119 to i8*
  %121 = call %struct.pair* @Ppair_alloc(i8* %120, i8* null)
  store %struct.pair* %121, %struct.pair** %insertPtr8, align 8
  %122 = load %struct.pair*, %struct.pair** %insertPtr8, align 8
  %123 = icmp ne %struct.pair* %122, null
  br i1 %123, label %124, label %132

; <label>:124                                     ; preds = %118
  %125 = load %struct.jsw_avltree*, %struct.jsw_avltree** %3, align 8
  %126 = load %struct.pair*, %struct.pair** %insertPtr8, align 8
  %127 = bitcast %struct.pair* %126 to i8*
  %128 = call i64 @Pjsw_avlinsert(%struct.jsw_avltree* %125, i8* %127)
...
; <label>:132                                     ; preds = %131, %118
  %133 = load i64, i64* %success7, align 8
  store i64 %133, i64* %9, align 8
  %134 = load i64, i64* %9, align 8
  store i64 %134, i64* %isSuccess2, align 8
  %135 = load i64, i64* %isSuccess2, align 8
...
; <label>:145                                     ; preds = %__kernel__TMmesh_insert0
  %146 = load %struct.element*, %struct.element** %2, align 8
  %147 = call %struct.pair* @element_getEncroachedPtr(%struct.element* %146)
  store %struct.pair* %147, %struct.pair** %encroachedPtr, align 8
  %148 = load %struct.pair*, %struct.pair** %encroachedPtr, align 8
  %149 = icmp ne %struct.pair* %148, null
  br i1 %149, label %150, label %161

; <label>:150                                     ; preds = %145
  %151 = load %struct.mesh*, %struct.mesh** %1, align 8
  %152 = getelementptr inbounds %struct.mesh, %struct.mesh* %151, i32 0, i32 3
  %153 = load %struct.rbtree*, %struct.rbtree** %152, align 8
  %154 = load %struct.pair*, %struct.pair** %encroachedPtr, align 8
  %155 = bitcast %struct.pair* %154 to i8*
  %156 = call i64 @TMrbtree_contains(%struct.rbtree* %153, i8* %155)
  %157 = icmp ne i64 %156, 0
  br i1 %157, label %160, label %158

; <label>:158                                     ; preds = %150
  %159 = load %struct.element*, %struct.element** %2, align 8
  call void @element_clearEncroached(%struct.element* %159)
  br label %160
