...
.lr.ph20:                                         ; preds = %.lr.ph20, %.lr.ph20.preheader
  ...
  %17 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %18 = icmp eq i64 %17, 0
...
; <label>:20                                      ; preds = %._crit_edge21
  ...
  %22 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 0, i64 0, i64 0, i64 4294967295) #9, !srcloc !13
  %23 = trunc i64 %22 to i32
  %24 = icmp eq i32 %23, -1
  br i1 %24, label %25, label %.outer8

; <label>:25                                      ; preds = %20
  %26 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %27 = icmp eq i64 %26, 0
...
; <label>:29                                      ; preds = %28, %25
  %30 = tail call i8* @TMheap_remove(%struct.heap* %5) #9
...
; <label>:31                                      ; preds = %._crit_edge21
  ...
  %32 = tail call i8* @TMheap_remove(%struct.heap* %5) #9
...
.lr.ph22:                                         ; preds = %.lr.ph22.preheader, %.lr.ph22
  tail call void @llvm.x86.sse2.pause() #9
  %36 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %37 = icmp eq i64 %36, 0
...
; <label>:39                                      ; preds = %._crit_edge23
  ...
  %41 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 1, i64 0, i64 1, i64 4294967295) #9, !srcloc !13
  %42 = trunc i64 %41 to i32
  %43 = icmp eq i32 %42, -1
  br i1 %43, label %46, label %.outer7

.outer7:                                          ; preds = %39, %.outer7.preheader
  %tries2.0.ph = phi i32 [ %40, %39 ], [ 9, %.outer7.preheader ]
  %44 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %45 = icmp eq i64 %44, 0
...
; <label>:46                                      ; preds = %39
  %47 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %48 = icmp eq i64 %47, 0
  br i1 %48, label %50, label %49
...
; <label>:50                                      ; preds = %49, %46
  %51 = tail call i64 @TMelement_isGarbage(%struct.element* %34) #9
...
; <label>:52                                      ; preds = %._crit_edge23
  tail call void (...) bitcast (void ()* @RTM_fallback_lock to void (...)*)() #9
  %53 = tail call i64 @TMelement_isGarbage(%struct.element* %34) #9
  tail call void (...) bitcast (void ()* @RTM_fallback_unlock to void (...)*)() #9
  br label %54
...
.outer5:                                          ; preds = %63, %.outer5.preheader
  %tries4.0.ph = phi i32 [ %64, %63 ], [ 9, %.outer5.preheader ]
  %57 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %58 = icmp eq i64 %57, 0
...
.lr.ph24:                                         ; preds = %.lr.ph24, %.lr.ph24.preheader
  tail call void @llvm.x86.sse2.pause() #9
  %59 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %60 = icmp eq i64 %59, 0
...
; <label>:63                                      ; preds = %._crit_edge25
  ...
  %65 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 2, i64 0, i64 2, i64 4294967295) #9, !srcloc !13
...
; <label>:68                                      ; preds = %63
  ...
  %69 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %70 = icmp eq i64 %69, 0
...
; <label>:72                                      ; preds = %71, %68, %62
  ...
  %73 = tail call i64 @TMregion_refine(%struct.region* nonnull %7, %struct.element* %.lcssa60, %struct.mesh* %6) #9
...
.outer3:                                          ; preds = %83, %.outer3.preheader
  %tries6.0.ph = phi i32 [ %84, %83 ], [ 9, %.outer3.preheader ]
  %77 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %78 = icmp eq i64 %77, 0
...
.lr.ph26:                                         ; preds = %.lr.ph26, %.lr.ph26.preheader
  tail call void @llvm.x86.sse2.pause() #9
  %79 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %80 = icmp eq i64 %79, 0
...
; <label>:83                                      ; preds = %._crit_edge27
  ...
  %85 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 3, i64 0, i64 3, i64 4294967295) #9, !srcloc !13
...
; <label>:88                                      ; preds = %83
  ...
  %89 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %90 = icmp eq i64 %89, 0
...
; <label>:92                                      ; preds = %91, %88, %82
  ...
  %93 = tail call i64 @TMelement_isGarbage(%struct.element* %.lcssa60) #9
...
.outer1:                                          ; preds = %104, %97
  ...
  %99 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
...
.lr.ph28:                                         ; preds = %.lr.ph28, %.lr.ph28.preheader
  tail call void @llvm.x86.sse2.pause() #9
  %101 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
...
; <label>:104                                     ; preds = %._crit_edge29
  ...
  %106 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 4, i64 0, i64 4, i64 4294967295) #9, !srcloc !13
  %107 = trunc i64 %106 to i32
  %108 = icmp eq i32 %107, -1
  br i1 %108, label %109, label %.outer1

; <label>:109                                     ; preds = %104
  %110 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
  %111 = icmp eq i64 %110, 0
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  tail call void @llvm.x86.sse2.pause() #9
  %117 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
...
; <label>:121                                     ; preds = %._crit_edge
  ...
  %123 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 5, i64 0, i64 5, i64 4294967295) #9, !srcloc !13
  %124 = trunc i64 %123 to i32
  %125 = icmp eq i32 %124, -1
  br i1 %125, label %128, label %.outer

.outer:                                           ; preds = %121, %.outer.preheader
...
; <label>:128                                     ; preds = %121
  ...
  %129 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #9
...
; <label>:140                                     ; preds = %139, %138
  ...
  %141 = tail call i64 (...) bitcast (i64 ()* @thread_getId to i64 (...)*)() #9
  %142 = trunc i64 %141 to i32
  %143 = load i32, i32* %10, align 4
  tail call void @SimRoiEnd(i32 %142, i32 %143) #9
  ret void
}
