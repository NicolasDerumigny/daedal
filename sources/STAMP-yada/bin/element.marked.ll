...
__kernel__TMelement_alloc0:                       ; preds = %21, %7
  %8 = load i64, i64* %i, align 8
  %9 = load i64, i64* %2, align 8
  %10 = icmp slt i64 %8, %9
  br i1 %10, label %11, label %24

; <label>:11                                      ; preds = %__kernel__TMelement_alloc0
  %12 = load i64, i64* %i, align 8
  %13 = load %struct.element*, %struct.element** %elementPtr, align 8
  %14 = getelementptr inbounds %struct.element, %struct.element* %13, i32 0, i32 0
  %15 = getelementptr inbounds [3 x %struct.coordinate], [3 x %struct.coordinate]* %14, i64 0, i64 %12
  %16 = load i64, i64* %i, align 8
  %17 = load %struct.coordinate*, %struct.coordinate** %1, align 8
  %18 = getelementptr inbounds %struct.coordinate, %struct.coordinate* %17, i64 %16
  %19 = bitcast %struct.coordinate* %15 to i8*
...
; <label>:24                                      ; preds = %__kernel__TMelement_alloc0
  %25 = load i64, i64* %2, align 8
  %26 = load %struct.element*, %struct.element** %elementPtr, align 8
  %27 = getelementptr inbounds %struct.element, %struct.element* %26, i32 0, i32 1
  store i64 %25, i64* %27, align 8
  %28 = load %struct.element*, %struct.element** %elementPtr, align 8
  call void @minimizeCoordinates(%struct.element* %28)
  %29 = load %struct.element*, %struct.element** %elementPtr, align 8
  call void @checkAngles(%struct.element* %29)
  %30 = load %struct.element*, %struct.element** %elementPtr, align 8
  call void @calculateCircumCircle(%struct.element* %30)
  %31 = load %struct.element*, %struct.element** %elementPtr, align 8
  %32 = load %struct.coordinate*, %struct.coordinate** %1, align 8
  %33 = load i64, i64* %2, align 8
  call void @initEdges(%struct.element* %31, %struct.coordinate* %32, i64 %33)
  %34 = call %struct.list* @TMlist_alloc(i64 (i8*, i8*)* @element_listCompare)
  %35 = load %struct.element*, %struct.element** %elementPtr, align 8
  %36 = getelementptr inbounds %struct.element, %struct.element* %35, i32 0, i32 11
  store %struct.list* %34, %struct.list** %36, align 8
  %37 = load %struct.element*, %struct.element** %elementPtr, align 8
  %38 = getelementptr inbounds %struct.element, %struct.element* %37, i32 0, i32 11
  %39 = load %struct.list*, %struct.list** %38, align 8
  %40 = icmp ne %struct.list* %39, null
...
; <label>:44                                      ; preds = %43, %41
  %45 = load %struct.element*, %struct.element** %elementPtr, align 8
  %46 = getelementptr inbounds %struct.element, %struct.element* %45, i32 0, i32 12
  store i64 0, i64* %46, align 8
  %47 = load %struct.element*, %struct.element** %elementPtr, align 8
  %48 = getelementptr inbounds %struct.element, %struct.element* %47, i32 0, i32 13
  store i64 0, i64* %48, align 8
  br label %49

; <label>:49                                      ; preds = %44, %0
  %50 = load %struct.element*, %struct.element** %elementPtr, align 8
  ret %struct.element* %50
}
