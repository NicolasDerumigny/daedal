...
__kernel__TMelement_alloc0:                       ; preds = %12, %4
  %i.0 = phi i64 [ 0, %4 ], [ %13, %12 ]
  %6 = icmp slt i64 %i.0, %numCoordinate
  br i1 %6, label %7, label %14

; <label>:7                                       ; preds = %__kernel__TMelement_alloc0
  %8 = getelementptr inbounds [3 x %struct.coordinate], [3 x %struct.coordinate]* %5, i64 0, i64 %i.0
  %9 = getelementptr inbounds %struct.coordinate, %struct.coordinate* %coordinates, i64 %i.0
