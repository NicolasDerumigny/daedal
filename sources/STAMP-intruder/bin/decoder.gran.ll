...
@"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_vi" = external global i64
@"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_lsup" = external global i64
@"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_granularity" = external global i64
@"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_vi" = external global i64
@"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_lsup" = external global i64
@"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_granularity" = external global i64
...
; <label>:84                                      ; preds = %81
  call void @TMlist_iter_reset(%struct.list_node** %it, %struct.list* %30)
  br label %__kernel__TMdecoder_process1_outer_chunking

__kernel__TMdecoder_process1_outer_chunking:      ; preds = %84, %__kernel__TMdecoder_process1_exitChunk
  %numByte1.0 = phi i64 [ 0, %84 ], [ %numByte1.1, %__kernel__TMdecoder_process1_exitChunk ]
  %i.0 = phi i64 [ 0, %84 ], [ %i.1, %__kernel__TMdecoder_process1_exitChunk ]
  %lsup_value4 = load i64, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_lsup"
  store i64 %lsup_value4, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_vi"
  %granularity_value5 = load i64, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_granularity"
  %new_lsup6 = add i64 %lsup_value4, %granularity_value5
  store i64 %new_lsup6, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_lsup"
  %outer_vi7 = load i64, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_vi"
  br label %__kernel____kernel__TMdecoder_process1_viCond

__kernel____kernel__TMdecoder_process1_viCond:    ; preds = %__kernel__TMdecoder_process1_outer_chunking, %108
  %numByte1.1 = phi i64 [ %numByte1.0, %__kernel__TMdecoder_process1_outer_chunking ], [ %111, %108 ]
  %i.1 = phi i64 [ %i.0, %__kernel__TMdecoder_process1_outer_chunking ], [ %112, %108 ]
  %vi_value8 = phi i64 [ %outer_vi7, %__kernel__TMdecoder_process1_outer_chunking ], [ %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_vi_inc", %108 ]
  %lsup_value9 = load i64, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_lsup"
  %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_vi_cmp" = icmp slt i64 %vi_value8, %lsup_value9
  br i1 %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_vi_cmp", label %__kernel__TMdecoder_process1, label %__kernel__TMdecoder_process1_exitChunk

__kernel__TMdecoder_process1_exitChunk:           ; preds = %__kernel____kernel__TMdecoder_process1_viCond
  br label %__kernel__TMdecoder_process1_outer_chunking

__kernel__TMdecoder_process1:                     ; preds = %__kernel____kernel__TMdecoder_process1_viCond
...
; <label>:108                                     ; preds = %96
  ...
  %111 = add nsw i64 %numByte1.1, %110
  %112 = add nsw i64 %i.1, 1
  %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_vi_inc" = add i64 %vi_value8, 1
  store i64 %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_vi_inc", i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process1_vi"
  br label %__kernel____kernel__TMdecoder_process1_viCond, !llvm.loop !1

; <label>:113                                     ; preds = %__kernel__TMdecoder_process1
  %114 = add nsw i64 %numByte1.1, 1
...
; <label>:120                                     ; preds = %119, %117
  %121 = getelementptr inbounds i8, i8* %115, i64 %numByte1.1
  store i8 0, i8* %121, align 1
  call void @TMlist_iter_reset(%struct.list_node** %it, %struct.list* %30)
  br label %__kernel__TMdecoder_process0_outer_chunking

__kernel__TMdecoder_process0_outer_chunking:      ; preds = %120, %__kernel__TMdecoder_process0_exitChunk
  %dst.0 = phi i8* [ %115, %120 ], [ %dst.1, %__kernel__TMdecoder_process0_exitChunk ]
  %lsup_value = load i64, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_lsup"
  store i64 %lsup_value, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_vi"
  %granularity_value = load i64, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_granularity"
  %new_lsup = add i64 %lsup_value, %granularity_value
  store i64 %new_lsup, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_lsup"
  %outer_vi = load i64, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_vi"
  br label %__kernel____kernel__TMdecoder_process0_viCond

__kernel____kernel__TMdecoder_process0_viCond:    ; preds = %__kernel__TMdecoder_process0_outer_chunking, %124
  %dst.1 = phi i8* [ %dst.0, %__kernel__TMdecoder_process0_outer_chunking ], [ %133, %124 ]
  %vi_value = phi i64 [ %outer_vi, %__kernel__TMdecoder_process0_outer_chunking ], [ %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_vi_inc", %124 ]
  %lsup_value3 = load i64, i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_lsup"
  %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_vi_cmp" = icmp slt i64 %vi_value, %lsup_value3
  br i1 %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_vi_cmp", label %__kernel__TMdecoder_process0, label %__kernel__TMdecoder_process0_exitChunk

__kernel__TMdecoder_process0_exitChunk:           ; preds = %__kernel____kernel__TMdecoder_process0_viCond
  br label %__kernel__TMdecoder_process0_outer_chunking

__kernel__TMdecoder_process0:                     ; preds = %__kernel____kernel__TMdecoder_process0_viCond
...
; <label>:124                                     ; preds = %__kernel__TMdecoder_process0
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %dst.1, i8* %128, i64 %130, i32 1, i1 false)
  %131 = getelementptr inbounds %struct.packet, %struct.packet* %126, i32 0, i32 3
  %132 = load i64, i64* %131, align 8
  %133 = getelementptr inbounds i8, i8* %dst.1, i64 %132
  %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_vi_inc" = add i64 %vi_value, 1
  store i64 %"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_vi_inc", i64* @"../bin/decoder.marked.ll_TMdecoder_process___kernel__TMdecoder_process0_vi"
  br label %__kernel____kernel__TMdecoder_process0_viCond, !llvm.loop !3

; <label>:134                                     ; preds = %__kernel__TMdecoder_process0
  %135 = getelementptr inbounds i8, i8* %115, i64 %numByte1.1
  %136 = icmp eq i8* %dst.1, %135
