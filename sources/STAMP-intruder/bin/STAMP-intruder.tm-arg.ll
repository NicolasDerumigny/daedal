...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  ...
  %28 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %29 = icmp eq i64 %28, 0
...
; <label>:31                                      ; preds = %._crit_edge
  ...
  %33 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 0, i64 0, i64 0, i64 4294967295) #6, !srcloc !4
  %34 = trunc i64 %33 to i32
  %35 = icmp eq i32 %34, -1
  br i1 %35, label %36, label %.outer3

; <label>:36                                      ; preds = %31
  %37 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %38 = icmp eq i64 %37, 0
...
; <label>:40                                      ; preds = %39, %36
  %41 = call i8* @TMstream_getPacket(%struct.stream* %7) #6
...
; <label>:42                                      ; preds = %._crit_edge
  ...
  %43 = call i8* @TMstream_getPacket(%struct.stream* %7) #6
...
.outer2:                                          ; preds = %53, %.outer2.preheader
  %tries3.0.ph = phi i32 [ %54, %53 ], [ 9, %.outer2.preheader ]
  %47 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %48 = icmp eq i64 %47, 0
...
.lr.ph8:                                          ; preds = %.lr.ph8, %.lr.ph8.preheader
  call void @llvm.x86.sse2.pause() #6
  %49 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %50 = icmp eq i64 %49, 0
...
; <label>:53                                      ; preds = %._crit_edge9
  ...
  %55 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 1, i64 0, i64 1, i64 4294967295) #6, !srcloc !4
...
; <label>:58                                      ; preds = %53
  ...
  %59 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %60 = icmp eq i64 %59, 0
...
; <label>:62                                      ; preds = %61, %58, %52
  ...
  %66 = add i64 %65, 32
  %67 = call i32 @TMdecoder_process(%struct.decoder* %10, i8* nonnull %45, i64 %66) #6
...
; <label>:77                                      ; preds = %._crit_edge11
  ...
  %79 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 2, i64 0, i64 2, i64 4294967295) #6, !srcloc !4
  %80 = trunc i64 %79 to i32
  %81 = icmp eq i32 %80, -1
  br i1 %81, label %84, label %.outer

.outer:                                           ; preds = %77, %.outer.preheader
  %tries5.0.ph = phi i32 [ %78, %77 ], [ 9, %.outer.preheader ]
  %82 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %83 = icmp eq i64 %82, 0
...
; <label>:84                                      ; preds = %77
  %85 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %86 = icmp eq i64 %85, 0
...
; <label>:88                                      ; preds = %87, %84
  %89 = call i8* @TMdecoder_getComplete(%struct.decoder* %10, i64* nonnull %decodedFlowId) #6
  call void asm sideeffect "mov $0,%rcx\0A\09xend \0A\09", "r,~{rcx},~{dirflag},~{fpsr},~{flags}"(i64 2) #6, !srcloc !6
  br label %92

; <label>:90                                      ; preds = %._crit_edge11
  call void (...) bitcast (void ()* @RTM_fallback_lock to void (...)*)() #6
  %91 = call i8* @TMdecoder_getComplete(%struct.decoder* %10, i64* nonnull %decodedFlowId) #6
  call void (...) bitcast (void ()* @RTM_fallback_unlock to void (...)*)() #6
  br label %92
...
; <label>:95                                      ; preds = %92
  %96 = call i32 @detector_process(%struct.detector* nonnull %14, i8* nonnull %93) #6
  call void @free(i8* nonnull %93) #6
  %97 = icmp eq i32 %96, 0
  br i1 %97, label %103, label %98

; <label>:98                                      ; preds = %95
  %99 = load i8*, i8** %22, align 8
  %100 = call i64 @Pvector_pushBack(%struct.vector* %19, i8* %99) #6
...
; <label>:104                                     ; preds = %44
  ...
  %105 = call i64 (...) bitcast (i64 ()* @thread_getId to i64 (...)*)() #6
  %106 = trunc i64 %105 to i32
  %107 = load i32, i32* %21, align 4
  call void @SimRoiEnd(i32 %106, i32 %107) #6
  ret void
}
