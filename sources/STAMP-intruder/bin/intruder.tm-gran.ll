; ModuleID = '../bin/intruder.marked.ll'
...
; <label>:113                                     ; preds = %._crit_edge2, %112
  br label %114
...
; <label>:133                                     ; preds = %._crit_edge4, %132
  br label %134

; <label>:134                                     ; preds = %._crit_edge3, %133
  br label %135
...
; <label>:7                                       ; preds = %._crit_edge5, %._crit_edge4, %._crit_edge3, %._crit_edge2, %._crit_edge1
