...
__kernel__TMdecoder_process1:                     ; preds = %160, %126
  %128 = load %struct.list*, %struct.list** %fragmentListPtr, align 8
  %129 = call i64 @TMlist_iter_hasNext(%struct.list_node** %it, %struct.list* %128) #8
  %130 = icmp ne i64 %129, 0
  br i1 %130, label %131, label %168

; <label>:131                                     ; preds = %__kernel__TMdecoder_process1
  %132 = load %struct.list*, %struct.list** %fragmentListPtr, align 8
  %133 = call i8* @TMlist_iter_next(%struct.list_node** %it, %struct.list* %132)
  %134 = bitcast i8* %133 to %struct.packet*
  store %struct.packet* %134, %struct.packet** %fragmentPtr, align 8
  %135 = load %struct.packet*, %struct.packet** %fragmentPtr, align 8
  %136 = getelementptr inbounds %struct.packet, %struct.packet* %135, i32 0, i32 0
  %137 = load i64, i64* %136, align 8
  %138 = load i64, i64* %flowId, align 8
...
; <label>:143                                     ; preds = %142, %140
  %144 = load %struct.packet*, %struct.packet** %fragmentPtr, align 8
  %145 = getelementptr inbounds %struct.packet, %struct.packet* %144, i32 0, i32 1
...
; <label>:149                                     ; preds = %143
  %150 = load %struct.rbtree*, %struct.rbtree** %fragmentedMapPtr, align 8
  %151 = load i64, i64* %flowId, align 8
  %152 = inttoptr i64 %151 to i8*
  %153 = call i64 @TMrbtree_delete(%struct.rbtree* %150, i8* %152)
  store i64 %153, i64* %status, align 8
  %154 = load i64, i64* %status, align 8
...
; <label>:160                                     ; preds = %143
  %161 = load %struct.packet*, %struct.packet** %fragmentPtr, align 8
  %162 = getelementptr inbounds %struct.packet, %struct.packet* %161, i32 0, i32 3
  %163 = load i64, i64* %162, align 8
  %164 = load i64, i64* %numByte1, align 8
  %165 = add nsw i64 %164, %163
  store i64 %165, i64* %numByte1, align 8
  %166 = load i64, i64* %i, align 8
  %167 = add nsw i64 %166, 1
  store i64 %167, i64* %i, align 8
  br label %__kernel__TMdecoder_process1, !llvm.loop !1

; <label>:168                                     ; preds = %__kernel__TMdecoder_process1
  %169 = load i64, i64* %numByte1, align 8
  %170 = add nsw i64 %169, 1
  %171 = call noalias i8* @malloc(i64 %170) #6
  store i8* %171, i8** %data, align 8
...
; <label>:177                                     ; preds = %176, %174
  %178 = load i64, i64* %numByte1, align 8
  %179 = load i8*, i8** %data, align 8
  %180 = getelementptr inbounds i8, i8* %179, i64 %178
  store i8 0, i8* %180, align 1
  %181 = load i8*, i8** %data, align 8
  store i8* %181, i8** %dst, align 8
  %182 = load %struct.list*, %struct.list** %fragmentListPtr, align 8
  call void @TMlist_iter_reset(%struct.list_node** %it, %struct.list* %182)
  br label %__kernel__TMdecoder_process0

__kernel__TMdecoder_process0:                     ; preds = %186, %177
  %183 = load %struct.list*, %struct.list** %fragmentListPtr, align 8
  %184 = call i64 @TMlist_iter_hasNext(%struct.list_node** %it, %struct.list* %183) #8
  %185 = icmp ne i64 %184, 0
  br i1 %185, label %186, label %202

; <label>:186                                     ; preds = %__kernel__TMdecoder_process0
  %187 = load %struct.list*, %struct.list** %fragmentListPtr, align 8
  %188 = call i8* @TMlist_iter_next(%struct.list_node** %it, %struct.list* %187)
  %189 = bitcast i8* %188 to %struct.packet*
  store %struct.packet* %189, %struct.packet** %fragmentPtr2, align 8
  %190 = load i8*, i8** %dst, align 8
  %191 = load %struct.packet*, %struct.packet** %fragmentPtr2, align 8
  %192 = getelementptr inbounds %struct.packet, %struct.packet* %191, i32 0, i32 4
  %193 = getelementptr inbounds [0 x i8], [0 x i8]* %192, i32 0, i32 0
  %194 = load %struct.packet*, %struct.packet** %fragmentPtr2, align 8
  %195 = getelementptr inbounds %struct.packet, %struct.packet* %194, i32 0, i32 3
  %196 = load i64, i64* %195, align 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %190, i8* %193, i64 %196, i32 1, i1 false)
  %197 = load %struct.packet*, %struct.packet** %fragmentPtr2, align 8
  %198 = getelementptr inbounds %struct.packet, %struct.packet* %197, i32 0, i32 3
  %199 = load i64, i64* %198, align 8
  %200 = load i8*, i8** %dst, align 8
  %201 = getelementptr inbounds i8, i8* %200, i64 %199
  store i8* %201, i8** %dst, align 8
  br label %__kernel__TMdecoder_process0, !llvm.loop !3

; <label>:202                                     ; preds = %__kernel__TMdecoder_process0
  %203 = load i8*, i8** %dst, align 8
  %204 = load i8*, i8** %data, align 8
  %205 = load i64, i64* %numByte1, align 8
...
; <label>:211                                     ; preds = %210, %208
  ...
  %213 = bitcast i8* %212 to %struct.decoded*
  store %struct.decoded* %213, %struct.decoded** %decodedPtr, align 8
  %214 = load %struct.decoded*, %struct.decoded** %decodedPtr, align 8
  %215 = icmp ne %struct.decoded* %214, null
...
; <label>:219                                     ; preds = %218, %216
  %220 = load i64, i64* %flowId, align 8
  %221 = load %struct.decoded*, %struct.decoded** %decodedPtr, align 8
  %222 = getelementptr inbounds %struct.decoded, %struct.decoded* %221, i32 0, i32 0
  store i64 %220, i64* %222, align 8
  %223 = load i8*, i8** %data, align 8
  %224 = load %struct.decoded*, %struct.decoded** %decodedPtr, align 8
  %225 = getelementptr inbounds %struct.decoded, %struct.decoded* %224, i32 0, i32 1
  store i8* %223, i8** %225, align 8
  %226 = load %struct.decoder*, %struct.decoder** %2, align 8
  %227 = getelementptr inbounds %struct.decoder, %struct.decoder* %226, i32 0, i32 1
  %228 = load %struct.queue*, %struct.queue** %227, align 8
  store %struct.queue* %228, %struct.queue** %decodedQueuePtr, align 8
  %229 = load %struct.queue*, %struct.queue** %decodedQueuePtr, align 8
  %230 = load %struct.decoded*, %struct.decoded** %decodedPtr, align 8
  %231 = bitcast %struct.decoded* %230 to i8*
  %232 = call i64 @TMqueue_push(%struct.queue* %229, i8* %231)
  store i64 %232, i64* %status, align 8
  %233 = load i64, i64* %status, align 8
...
; <label>:238                                     ; preds = %237, %235
  %239 = load %struct.list*, %struct.list** %fragmentListPtr, align 8
  call void @TMlist_free(%struct.list* %239)
  %240 = load %struct.rbtree*, %struct.rbtree** %fragmentedMapPtr, align 8
  %241 = load i64, i64* %flowId, align 8
  %242 = inttoptr i64 %241 to i8*
  %243 = call i64 @TMrbtree_delete(%struct.rbtree* %240, i8* %242)
  store i64 %243, i64* %status, align 8
  %244 = load i64, i64* %status, align 8
...
; <label>:251                                     ; preds = %250, %81
  br label %301

; <label>:252                                     ; preds = %38
  %253 = load i64, i64* %fragmentId, align 8
...
; <label>:256                                     ; preds = %252
  ...
  %259 = call noalias i8* @malloc(i64 %258) #6
  store i8* %259, i8** %data3, align 8
  %260 = load i8*, i8** %data3, align 8
...
; <label>:265                                     ; preds = %264, %262
  ...
  %267 = load i8*, i8** %data3, align 8
  %268 = getelementptr inbounds i8, i8* %267, i64 %266
  store i8 0, i8* %268, align 1
  %269 = load i8*, i8** %data3, align 8
  %270 = load %struct.packet*, %struct.packet** %packetPtr, align 8
  %271 = getelementptr inbounds %struct.packet, %struct.packet* %270, i32 0, i32 4
  %272 = getelementptr inbounds [0 x i8], [0 x i8]* %271, i32 0, i32 0
  %273 = load i64, i64* %length, align 8
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %269, i8* %272, i64 %273, i32 1, i1 false)
  %274 = call noalias i8* @malloc(i64 16) #6
  %275 = bitcast i8* %274 to %struct.decoded*
  store %struct.decoded* %275, %struct.decoded** %decodedPtr4, align 8
  %276 = load %struct.decoded*, %struct.decoded** %decodedPtr4, align 8
  %277 = icmp ne %struct.decoded* %276, null
...
; <label>:281                                     ; preds = %280, %278
  %282 = load i64, i64* %flowId, align 8
  %283 = load %struct.decoded*, %struct.decoded** %decodedPtr4, align 8
  %284 = getelementptr inbounds %struct.decoded, %struct.decoded* %283, i32 0, i32 0
  store i64 %282, i64* %284, align 8
  %285 = load i8*, i8** %data3, align 8
  %286 = load %struct.decoded*, %struct.decoded** %decodedPtr4, align 8
  %287 = getelementptr inbounds %struct.decoded, %struct.decoded* %286, i32 0, i32 1
  store i8* %285, i8** %287, align 8
  %288 = load %struct.decoder*, %struct.decoder** %2, align 8
  %289 = getelementptr inbounds %struct.decoder, %struct.decoder* %288, i32 0, i32 1
  %290 = load %struct.queue*, %struct.queue** %289, align 8
  store %struct.queue* %290, %struct.queue** %decodedQueuePtr5, align 8
  %291 = load %struct.queue*, %struct.queue** %decodedQueuePtr5, align 8
  %292 = load %struct.decoded*, %struct.decoded** %decodedPtr4, align 8
  %293 = bitcast %struct.decoded* %292 to i8*
  %294 = call i64 @TMqueue_push(%struct.queue* %291, i8* %293)
  store i64 %294, i64* %status, align 8
  %295 = load i64, i64* %status, align 8
...
; <label>:302                                     ; preds = %301, %255, %159, %110, %37, %33, %25, %7
