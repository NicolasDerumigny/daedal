...
.lr.ph93:                                         ; preds = %.lr.ph93, %.lr.ph93.preheader
  ...
  %49 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
  %50 = icmp eq i64 %49, 0
...
; <label>:53                                      ; preds = %._crit_edge94
  ...
  %55 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 0, i64 0, i64 0, i64 4294967295) #7, !srcloc !6
...
; <label>:58                                      ; preds = %53
  ...
  %59 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
  %60 = icmp eq i64 %59, 0
...
.lr.ph97:                                         ; preds = %.lr.ph97, %.lr.ph97.preheader
  ...
  br i1 %70, label %.lr.ph97, label %._crit_edge98.loopexit, !llvm.loop !8
...
; <label>:97                                      ; preds = %201, %91
  ...
  %98 = call i64 @list_iter_hasNext(%struct.list_node** nonnull %it, %struct.list* %96) #15
  %99 = icmp eq i64 %98, 0
...
.outer21:                                         ; preds = %110, %100
  ...
  %104 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph74:                                         ; preds = %.lr.ph74, %.lr.ph74.preheader
  ...
  %106 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:110                                     ; preds = %._crit_edge75
  ...
  %112 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 1, i64 0, i64 1, i64 4294967295) #7, !srcloc !6
...
; <label>:115                                     ; preds = %110
  ...
  %116 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph77:                                         ; preds = %.lr.ph77, %.lr.ph77.preheader
  ...
  br i1 %126, label %._crit_edge78.loopexit, label %.lr.ph77, !llvm.loop !11
...
; <label>:161                                     ; preds = %._crit_edge83
  ...
  %163 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 2, i64 0, i64 2, i64 4294967295) #7, !srcloc !6
...
.lr.ph86:                                         ; preds = %.lr.ph86.preheader, %.lr.ph86
  call void @llvm.x86.sse2.pause() #7
  %181 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:184                                     ; preds = %._crit_edge87
  ...
  %186 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 3, i64 0, i64 3, i64 4294967295) #7, !srcloc !6
  %187 = trunc i64 %186 to i32
  %188 = icmp eq i32 %187, -1
  br i1 %188, label %191, label %.outer19

.outer19:                                         ; preds = %184, %.preheader18
  %tries12.0.ph = phi i32 [ 9, %.preheader18 ], [ %185, %184 ]
  %189 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:229                                     ; preds = %.loopexit14, %.lr.ph56
...
; <label>:246                                     ; preds = %304, %233
  %247 = call i64 @list_iter_hasNext(%struct.list_node** nonnull %it16, %struct.list* %240) #15
...
.outer:                                           ; preds = %261, %249
  ...
  %255 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:261                                     ; preds = %._crit_edge53
  ...
  %263 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 4, i64 0, i64 4, i64 4294967295) #7, !srcloc !6
...
; <label>:277                                     ; preds = %274
  %278 = call i32 @strncmp(i8* %254, i8* %242, i64 %substringLength.070) #15
...
; <label>:300                                     ; preds = %290, %277, %274, %270
...
.loopexit14.loopexit:                             ; preds = %304, %246
  br label %.loopexit14
...
.lr.ph65:                                         ; preds = %359, %.lr.ph65.preheader
...
; <label>:359                                     ; preds = %hashString.exit6, %.lr.ph65
...
.lr.ph49.preheader.split:                         ; preds = %375, %.lr.ph49.preheader
...
.lr.ph49.1180:                                    ; preds = %380, %.lr.ph49
...
.lr.ph:                                           ; preds = %421, %.lr.ph.preheader
...
; <label>:425                                     ; preds = %._crit_edge, %._crit_edge73
  %426 = call i64 (...) bitcast (i64 ()* @thread_getId to i64 (...)*)() #7
