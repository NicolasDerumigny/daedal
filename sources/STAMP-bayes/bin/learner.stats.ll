...
; <label>:51                                      ; preds = %133, %0
  %52 = load i64, i64* %i, align 8
  %53 = load i64, i64* %numParent, align 8
  %54 = icmp slt i64 %52, %53
  br i1 %54, label %55, label %136

; <label>:55                                      ; preds = %51
  %56 = load %struct.vector*, %struct.vector** %origParentQueryVectorPtr, align 8
  %57 = load i64, i64* %i, align 8
  %58 = call i8* @vector_at(%struct.vector* %56, i64 %57)
  %59 = bitcast i8* %58 to %struct.query*
  store %struct.query* %59, %struct.query** %queryPtr, align 8
  %60 = load %struct.query*, %struct.query** %queryPtr, align 8
  %61 = getelementptr inbounds %struct.query, %struct.query* %60, i32 0, i32 0
  %62 = load i64, i64* %61, align 8
  store i64 %62, i64* %fromId, align 8
  %63 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  call void @vector_clear(%struct.vector* %63)
  store i64 0, i64* %p, align 8
  br label %64

; <label>:64                                      ; preds = %92, %55
  %65 = load i64, i64* %p, align 8
  %66 = load i64, i64* %numParent, align 8
  %67 = icmp slt i64 %65, %66
  br i1 %67, label %68, label %95

; <label>:68                                      ; preds = %64
  %69 = load i64, i64* %p, align 8
  %70 = load i64, i64* %fromId, align 8
  %71 = icmp ne i64 %69, %70
  br i1 %71, label %72, label %91

; <label>:72                                      ; preds = %68
  %73 = load %struct.vector*, %struct.vector** %origParentQueryVectorPtr, align 8
  %74 = load i64, i64* %p, align 8
  %75 = call i8* @vector_at(%struct.vector* %73, i64 %74)
  %76 = bitcast i8* %75 to %struct.query*
  store %struct.query* %76, %struct.query** %queryPtr1, align 8
  %77 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %78 = load %struct.query*, %struct.query** %queryPtr1, align 8
  %79 = getelementptr inbounds %struct.query, %struct.query* %78, i32 0, i32 0
  %80 = load i64, i64* %79, align 8
  %81 = load %struct.query*, %struct.query** %queries, align 8
  %82 = getelementptr inbounds %struct.query, %struct.query* %81, i64 %80
  %83 = bitcast %struct.query* %82 to i8*
  %84 = call i64 @Pvector_pushBack(%struct.vector* %77, i8* %83)
  store i64 %84, i64* %status, align 8
  %85 = load i64, i64* %status, align 8
  %86 = icmp ne i64 %85, 0
...
; <label>:92                                      ; preds = %91
  ...
  %94 = add nsw i64 %93, 1
  store i64 %94, i64* %p, align 8
  br label %64

; <label>:95                                      ; preds = %64
  %96 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  %97 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %98 = call i64 @Pvector_copy(%struct.vector* %96, %struct.vector* %97)
  store i64 %98, i64* %status, align 8
  %99 = load i64, i64* %status, align 8
...
; <label>:104                                     ; preds = %103, %101
  %105 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  %106 = load i64, i64* %toId, align 8
  %107 = load %struct.query*, %struct.query** %queries, align 8
  %108 = getelementptr inbounds %struct.query, %struct.query* %107, i64 %106
  %109 = bitcast %struct.query* %108 to i8*
  %110 = call i64 @Pvector_pushBack(%struct.vector* %105, i8* %109)
  store i64 %110, i64* %status, align 8
  %111 = load i64, i64* %status, align 8
...
; <label>:116                                     ; preds = %115, %113
  %117 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  call void @vector_sort(%struct.vector* %117, i32 (i8*, i8*)* @compareQuery)
  %118 = load i64, i64* %toId, align 8
  %119 = load %struct.adtree*, %struct.adtree** %adtreePtr, align 8
  %120 = load %struct.net*, %struct.net** %netPtr, align 8
  %121 = load %struct.query*, %struct.query** %queries, align 8
  %122 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  %123 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %124 = call float @computeLocalLogLikelihood(i64 %118, %struct.adtree* %119, %struct.net* %120, %struct.query* %121, %struct.vector* %122, %struct.vector* %123)
  store float %124, float* %newLocalLogLikelihood, align 4
  %125 = load float, float* %newLocalLogLikelihood, align 4
  %126 = load float, float* %bestLocalLogLikelihood, align 4
  %127 = fcmp ogt float %125, %126
  br i1 %127, label %128, label %132

; <label>:128                                     ; preds = %116
  %129 = load float, float* %newLocalLogLikelihood, align 4
  store float %129, float* %bestLocalLogLikelihood, align 4
  %130 = load i64, i64* %fromId, align 8
  %131 = sitofp i64 %130 to float
  store float %131, float* %bestFromId, align 4
  br label %132
...
; <label>:136                                     ; preds = %51
  %137 = getelementptr inbounds %struct.learner_task, %struct.learner_task* %bestTask, i32 0, i32 0
  store i32 1, i32* %137, align 8
  %138 = load float, float* %bestFromId, align 4
  %139 = fptosi float %138 to i64
  %140 = getelementptr inbounds %struct.learner_task, %struct.learner_task* %bestTask, i32 0, i32 1
  store i64 %139, i64* %140, align 8
  %141 = load i64, i64* %toId, align 8
  %142 = getelementptr inbounds %struct.learner_task, %struct.learner_task* %bestTask, i32 0, i32 2
  ...
  %144 = load float, float* %bestFromId, align 4
  %145 = load i64, i64* %toId, align 8
  %146 = sitofp i64 %145 to float
  %147 = fcmp une float %144, %146
  br i1 %147, label %148, label %170

; <label>:148                                     ; preds = %136
  %149 = load %struct.adtree*, %struct.adtree** %adtreePtr, align 8
  %150 = getelementptr inbounds %struct.adtree, %struct.adtree* %149, i32 0, i32 1
  %151 = load i64, i64* %150, align 8
  store i64 %151, i64* %numRecord, align 8
  %152 = load i64, i64* %numTotalParent, align 8
  %153 = sub nsw i64 %152, 1
  %154 = sitofp i64 %153 to float
  %155 = load float, float* %basePenalty, align 4
  %156 = fmul float %154, %155
  store float %156, float* %penalty, align 4
  %157 = load i64, i64* %numRecord, align 8
  %158 = sitofp i64 %157 to float
  %159 = load float, float* %baseLogLikelihood, align 4
  %160 = load float, float* %bestLocalLogLikelihood, align 4
  %161 = fadd float %159, %160
  %162 = load float, float* %oldLocalLogLikelihood, align 4
  %163 = fsub float %161, %162
  %164 = fmul float %158, %163
  store float %164, float* %logLikelihood, align 4
  %165 = load float, float* %penalty, align 4
  %166 = load float, float* %logLikelihood, align 4
  %167 = fadd float %165, %166
  store float %167, float* %bestScore, align 4
  %168 = load float, float* %bestScore, align 4
  %169 = getelementptr inbounds %struct.learner_task, %struct.learner_task* %bestTask, i32 0, i32 3
  store float %168, float* %169, align 8
  br label %170

; <label>:170                                     ; preds = %148, %136
  %171 = bitcast %struct.learner_task* %agg.result to i8*
  %172 = bitcast %struct.learner_task* %bestTask to i8*
...
; <label>:59                                      ; preds = %203, %0
  %60 = load i64, i64* %i, align 8
  %61 = load i64, i64* %numParent, align 8
  %62 = icmp slt i64 %60, %61
  br i1 %62, label %63, label %206

; <label>:63                                      ; preds = %59
  %64 = load %struct.vector*, %struct.vector** %toOrigParentQueryVectorPtr, align 8
  %65 = load i64, i64* %i, align 8
  %66 = call i8* @vector_at(%struct.vector* %64, i64 %65)
  %67 = bitcast i8* %66 to %struct.query*
  store %struct.query* %67, %struct.query** %queryPtr, align 8
  %68 = load %struct.query*, %struct.query** %queryPtr, align 8
  %69 = getelementptr inbounds %struct.query, %struct.query* %68, i32 0, i32 0
  %70 = load i64, i64* %69, align 8
  store i64 %70, i64* %fromId, align 8
  %71 = load float, float* %oldLocalLogLikelihood, align 4
  %72 = load i64, i64* %fromId, align 8
  %73 = load float*, float** %localBaseLogLikelihoods, align 8
  %74 = getelementptr inbounds float, float* %73, i64 %72
  %75 = load float, float* %74, align 4
  %76 = fadd float %71, %75
  store float %76, float* %bestLocalLogLikelihood, align 4
  %77 = load %struct.net*, %struct.net** %netPtr, align 8
  %78 = load i64, i64* %fromId, align 8
  %79 = load %struct.query*, %struct.query** %queries, align 8
  %80 = load %struct.vector*, %struct.vector** %fromOrigParentQueryVectorPtr, align 8
  call void @TMpopulateParentQueryVector(%struct.net* %77, i64 %78, %struct.query* %79, %struct.vector* %80)
  %81 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  call void @vector_clear(%struct.vector* %81)
  store i64 0, i64* %p, align 8
  br label %82

; <label>:82                                      ; preds = %110, %63
  %83 = load i64, i64* %p, align 8
  %84 = load i64, i64* %numParent, align 8
  %85 = icmp slt i64 %83, %84
  br i1 %85, label %86, label %113

; <label>:86                                      ; preds = %82
  %87 = load i64, i64* %p, align 8
  %88 = load i64, i64* %fromId, align 8
  %89 = icmp ne i64 %87, %88
  br i1 %89, label %90, label %109

; <label>:90                                      ; preds = %86
  %91 = load %struct.vector*, %struct.vector** %toOrigParentQueryVectorPtr, align 8
  %92 = load i64, i64* %p, align 8
  %93 = call i8* @vector_at(%struct.vector* %91, i64 %92)
  %94 = bitcast i8* %93 to %struct.query*
  store %struct.query* %94, %struct.query** %queryPtr1, align 8
  %95 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %96 = load %struct.query*, %struct.query** %queryPtr1, align 8
  %97 = getelementptr inbounds %struct.query, %struct.query* %96, i32 0, i32 0
  %98 = load i64, i64* %97, align 8
  %99 = load %struct.query*, %struct.query** %queries, align 8
  %100 = getelementptr inbounds %struct.query, %struct.query* %99, i64 %98
  %101 = bitcast %struct.query* %100 to i8*
  %102 = call i64 @Pvector_pushBack(%struct.vector* %95, i8* %101)
...
; <label>:110                                     ; preds = %109
  ...
  store i64 %112, i64* %p, align 8
  br label %82

; <label>:113                                     ; preds = %82
  %114 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  %115 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %116 = call i64 @Pvector_copy(%struct.vector* %114, %struct.vector* %115)
  store i64 %116, i64* %status, align 8
  %117 = load i64, i64* %status, align 8
...
; <label>:122                                     ; preds = %121, %119
  %123 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  %124 = load i64, i64* %toId, align 8
  %125 = load %struct.query*, %struct.query** %queries, align 8
  %126 = getelementptr inbounds %struct.query, %struct.query* %125, i64 %124
  %127 = bitcast %struct.query* %126 to i8*
  %128 = call i64 @Pvector_pushBack(%struct.vector* %123, i8* %127)
  store i64 %128, i64* %status, align 8
  %129 = load i64, i64* %status, align 8
  %130 = icmp ne i64 %129, 0
...
; <label>:134                                     ; preds = %133, %131
  %135 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  call void @vector_sort(%struct.vector* %135, i32 (i8*, i8*)* @compareQuery)
  %136 = load i64, i64* %toId, align 8
  %137 = load %struct.adtree*, %struct.adtree** %adtreePtr, align 8
  %138 = load %struct.net*, %struct.net** %netPtr, align 8
  %139 = load %struct.query*, %struct.query** %queries, align 8
  %140 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  %141 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %142 = call float @computeLocalLogLikelihood(i64 %136, %struct.adtree* %137, %struct.net* %138, %struct.query* %139, %struct.vector* %140, %struct.vector* %141)
  store float %142, float* %newLocalLogLikelihood, align 4
  %143 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %144 = load %struct.vector*, %struct.vector** %fromOrigParentQueryVectorPtr, align 8
  %145 = call i64 @Pvector_copy(%struct.vector* %143, %struct.vector* %144)
  store i64 %145, i64* %status, align 8
  %146 = load i64, i64* %status, align 8
...
; <label>:151                                     ; preds = %150, %148
  %152 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %153 = load i64, i64* %toId, align 8
  %154 = load %struct.query*, %struct.query** %queries, align 8
  %155 = getelementptr inbounds %struct.query, %struct.query* %154, i64 %153
  %156 = bitcast %struct.query* %155 to i8*
  %157 = call i64 @Pvector_pushBack(%struct.vector* %152, i8* %156)
...
; <label>:163                                     ; preds = %162, %160
  %164 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  call void @vector_sort(%struct.vector* %164, i32 (i8*, i8*)* @compareQuery)
  %165 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  %166 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %167 = call i64 @Pvector_copy(%struct.vector* %165, %struct.vector* %166)
  store i64 %167, i64* %status, align 8
  %168 = load i64, i64* %status, align 8
...
; <label>:173                                     ; preds = %172, %170
  %174 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  %175 = load i64, i64* %fromId, align 8
  %176 = load %struct.query*, %struct.query** %queries, align 8
  %177 = getelementptr inbounds %struct.query, %struct.query* %176, i64 %175
  %178 = bitcast %struct.query* %177 to i8*
  %179 = call i64 @Pvector_pushBack(%struct.vector* %174, i8* %178)
  store i64 %179, i64* %status, align 8
  %180 = load i64, i64* %status, align 8
  %181 = icmp ne i64 %180, 0
  br i1 %181, label %182, label %183
...
; <label>:185                                     ; preds = %184, %182
  %186 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  call void @vector_sort(%struct.vector* %186, i32 (i8*, i8*)* @compareQuery)
  %187 = load i64, i64* %fromId, align 8
  %188 = load %struct.adtree*, %struct.adtree** %adtreePtr, align 8
  %189 = load %struct.net*, %struct.net** %netPtr, align 8
  %190 = load %struct.query*, %struct.query** %queries, align 8
  %191 = load %struct.vector*, %struct.vector** %queryVectorPtr, align 8
  %192 = load %struct.vector*, %struct.vector** %parentQueryVectorPtr, align 8
  %193 = call float @computeLocalLogLikelihood(i64 %187, %struct.adtree* %188, %struct.net* %189, %struct.query* %190, %struct.vector* %191, %struct.vector* %192)
  %194 = load float, float* %newLocalLogLikelihood, align 4
  %195 = fadd float %194, %193
  store float %195, float* %newLocalLogLikelihood, align 4
  %196 = load float, float* %newLocalLogLikelihood, align 4
  %197 = load float, float* %bestLocalLogLikelihood, align 4
  %198 = fcmp ogt float %196, %197
  br i1 %198, label %199, label %202

; <label>:199                                     ; preds = %185
  %200 = load float, float* %newLocalLogLikelihood, align 4
  store float %200, float* %bestLocalLogLikelihood, align 4
  %201 = load i64, i64* %fromId, align 8
  store i64 %201, i64* %bestFromId, align 8
  br label %202
...
; <label>:206                                     ; preds = %59
  %207 = load i64, i64* %bestFromId, align 8
  %208 = load i64, i64* %toId, align 8
  %209 = icmp ne i64 %207, %208
  br i1 %209, label %210, label %231

; <label>:210                                     ; preds = %206
  store i64 1, i64* %isTaskValid, align 8
  %211 = load %struct.net*, %struct.net** %netPtr, align 8
  %212 = load i64, i64* %bestFromId, align 8
  %213 = load i64, i64* %toId, align 8
  call void @TMnet_applyOperation(%struct.net* %211, i32 1, i64 %212, i64 %213)
  %214 = load %struct.net*, %struct.net** %netPtr, align 8
  %215 = load i64, i64* %bestFromId, align 8
  %216 = load i64, i64* %toId, align 8
  %217 = load %struct.bitmap*, %struct.bitmap** %visitedBitmapPtr, align 8
  %218 = load %struct.queue*, %struct.queue** %workQueuePtr, align 8
  %219 = call i64 @TMnet_isPath(%struct.net* %214, i64 %215, i64 %216, %struct.bitmap* %217, %struct.queue* %218)
...
; <label>:222                                     ; preds = %221, %210
  %223 = load %struct.net*, %struct.net** %netPtr, align 8
  %224 = load i64, i64* %bestFromId, align 8
  %225 = load i64, i64* %toId, align 8
  call void @TMnet_applyOperation(%struct.net* %223, i32 0, i64 %224, i64 %225)
  %226 = load i64, i64* %isTaskValid, align 8
  %227 = icmp ne i64 %226, 0
  br i1 %227, label %230, label %228

; <label>:228                                     ; preds = %222
  %229 = load i64, i64* %toId, align 8
  store i64 %229, i64* %bestFromId, align 8
  br label %230
...
; <label>:231                                     ; preds = %230, %206
  %232 = getelementptr inbounds %struct.learner_task, %struct.learner_task* %bestTask, i32 0, i32 0
  store i32 2, i32* %232, align 8
  %233 = load i64, i64* %bestFromId, align 8
  %234 = getelementptr inbounds %struct.learner_task, %struct.learner_task* %bestTask, i32 0, i32 1
  store i64 %233, i64* %234, align 8
  %235 = load i64, i64* %toId, align 8
  %236 = getelementptr inbounds %struct.learner_task, %struct.learner_task* %bestTask, i32 0, i32 2
  store i64 %235, i64* %236, align 8
  %237 = getelementptr inbounds %struct.learner_task, %struct.learner_task* %bestTask, i32 0, i32 3
  store float 0.000000e+00, float* %237, align 8
  %238 = load i64, i64* %bestFromId, align 8
  %239 = load i64, i64* %toId, align 8
  %240 = icmp ne i64 %238, %239
  br i1 %240, label %241, label %268

; <label>:241                                     ; preds = %231
  %242 = load i64, i64* %bestFromId, align 8
  %243 = load float*, float** %localBaseLogLikelihoods, align 8
  %244 = getelementptr inbounds float, float* %243, i64 %242
  %245 = load float, float* %244, align 4
  store float %245, float* %fromLocalLogLikelihood, align 4
  %246 = load %struct.adtree*, %struct.adtree** %adtreePtr, align 8
  %247 = getelementptr inbounds %struct.adtree, %struct.adtree* %246, i32 0, i32 1
  %248 = load i64, i64* %247, align 8
  store i64 %248, i64* %numRecord, align 8
  %249 = load i64, i64* %numTotalParent, align 8
  %250 = sitofp i64 %249 to float
  %251 = load float, float* %basePenalty, align 4
  %252 = fmul float %250, %251
  store float %252, float* %penalty, align 4
  %253 = load i64, i64* %numRecord, align 8
  %254 = sitofp i64 %253 to float
  %255 = load float, float* %baseLogLikelihood, align 4
  %256 = load float, float* %bestLocalLogLikelihood, align 4
  %257 = fadd float %255, %256
  %258 = load float, float* %oldLocalLogLikelihood, align 4
  %259 = fsub float %257, %258
  %260 = load float, float* %fromLocalLogLikelihood, align 4
  %261 = fsub float %259, %260
  %262 = fmul float %254, %261
  store float %262, float* %logLikelihood, align 4
  %263 = load float, float* %penalty, align 4
  %264 = load float, float* %logLikelihood, align 4
  %265 = fadd float %263, %264
  store float %265, float* %bestScore, align 4
  %266 = load float, float* %bestScore, align 4
  %267 = getelementptr inbounds %struct.learner_task, %struct.learner_task* %bestTask, i32 0, i32 3
  store float %266, float* %267, align 8
  br label %268

; <label>:268                                     ; preds = %241, %231
  %269 = bitcast %struct.learner_task* %agg.result to i8*
  %270 = bitcast %struct.learner_task* %bestTask to i8*
