...
; <label>:109                                     ; preds = %102
  %110 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:123                                     ; preds = %118, %113
  %124 = bitcast %struct.timeval* %parentQuery to i8*
  %125 = call i64 @Pvector_pushBack(%struct.vector* nonnull %27, i8* %124) #7
...
.lr.ph43:                                         ; preds = %.preheader11
  %127 = getelementptr inbounds [2 x %struct.timeval], [2 x %struct.timeval]* %queries, i64 0, i64 0, i32 0
  %128 = getelementptr inbounds [2 x %struct.timeval], [2 x %struct.timeval]* %queries, i64 0, i64 1
  %129 = bitcast %struct.timeval* %128 to i8*
  %130 = icmp sgt i64 %32, 0
  %131 = sitofp i64 %34 to float
  %132 = getelementptr inbounds %struct.timeval, %struct.timeval* %parentQuery, i64 0, i32 0
  %133 = getelementptr inbounds %struct.timeval, %struct.timeval* %128, i64 0, i32 0
  %134 = getelementptr inbounds [2 x %struct.timeval], [2 x %struct.timeval]* %queries, i64 0, i64 0, i32 1
  %135 = getelementptr inbounds [2 x %struct.timeval], [2 x %struct.timeval]* %queries, i64 0, i64 1, i32 1
  %136 = getelementptr inbounds %struct.timeval, %struct.timeval* %parentQuery, i64 0, i32 1
  br label %138
...
; <label>:138                                     ; preds = %273, %.lr.ph43
  ...
  %141 = call i64 @Pvector_pushBack(%struct.vector* nonnull %18, i8* %129) #7
...
._crit_edge.thread:                               ; preds = %.preheader
  %143 = call i8* @vector_popBack(%struct.vector* nonnull %18) #7
  br label %273
...
.lr.ph:                                           ; preds = %233, %.lr.ph.preheader
...
; <label>:146                                     ; preds = %.lr.ph
  ...
  %148 = call i64 @adtree_getCount(%struct.adtree* %11, %struct.vector* nonnull %18) #7
...
; <label>:150                                     ; preds = %146
  ...
  %155 = call i64 @adtree_getCount(%struct.adtree* %11, %struct.vector* nonnull %27) #7
...
; <label>:161                                     ; preds = %158
  ...
  %164 = call double @log(double %163) #7
  %165 = fmul double %154, %164
  %166 = fptrunc double %165 to float
  br label %computeSpecificLocalLogLikelihood.exit4

computeSpecificLocalLogLikelihood.exit4:          ; preds = %161, %146
  ...
  %171 = call i64 @adtree_getCount(%struct.adtree* %11, %struct.vector* nonnull %18) #7
...
; <label>:173                                     ; preds = %computeSpecificLocalLogLikelihood.exit4
  ...
  %178 = call i64 @adtree_getCount(%struct.adtree* %11, %struct.vector* nonnull %27) #7
...
; <label>:184                                     ; preds = %181
  ...
  %187 = call double @log(double %186) #7
  %188 = fmul double %177, %187
  %189 = fptrunc double %188 to float
  br label %computeSpecificLocalLogLikelihood.exit6

computeSpecificLocalLogLikelihood.exit6:          ; preds = %184, %computeSpecificLocalLogLikelihood.exit4
  ...
  %191 = call i64 @adtree_getCount(%struct.adtree* %11, %struct.vector* nonnull %18) #7
...
; <label>:193                                     ; preds = %computeSpecificLocalLogLikelihood.exit6
  ...
  %198 = call i64 @adtree_getCount(%struct.adtree* %11, %struct.vector* nonnull %27) #7
...
; <label>:204                                     ; preds = %201
  ...
  %207 = call double @log(double %206) #7
  %208 = fmul double %197, %207
  %209 = fptrunc double %208 to float
  br label %computeSpecificLocalLogLikelihood.exit8

computeSpecificLocalLogLikelihood.exit8:          ; preds = %204, %computeSpecificLocalLogLikelihood.exit6
  %.0.i7 = phi float [ %209, %204 ], [ 0.000000e+00, %computeSpecificLocalLogLikelihood.exit6 ]
  %210 = fadd float %190, %.0.i7
  store i64 1, i64* %134, align 8
  store i64 1, i64* %135, align 8
  store i64 1, i64* %136, align 8
  %211 = call i64 @adtree_getCount(%struct.adtree* %11, %struct.vector* nonnull %18) #7
...
; <label>:213                                     ; preds = %computeSpecificLocalLogLikelihood.exit8
  ...
  %218 = call i64 @adtree_getCount(%struct.adtree* %11, %struct.vector* nonnull %27) #7
...
; <label>:224                                     ; preds = %221
  ...
  %227 = call double @log(double %226) #7
  %228 = fmul double %217, %227
  %229 = fptrunc double %228 to float
  br label %computeSpecificLocalLogLikelihood.exit10

computeSpecificLocalLogLikelihood.exit10:         ; preds = %224, %computeSpecificLocalLogLikelihood.exit8
...
; <label>:233                                     ; preds = %232, %computeSpecificLocalLogLikelihood.exit10, %.lr.ph
...
._crit_edge:                                      ; preds = %233
  ...
  %236 = call i8* @vector_popBack(%struct.vector* nonnull %18) #7
...
.outer:                                           ; preds = %254, %238
  ...
  %249 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph40:                                         ; preds = %.lr.ph40, %.lr.ph40.preheader
  call void @llvm.x86.sse2.pause() #7
  %251 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:254                                     ; preds = %._crit_edge41
  ...
  %256 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 1, i64 0, i64 1, i64 4294967295) #7, !srcloc !3
...
; <label>:263                                     ; preds = %262, %259
  ...
  %265 = call i64 @TMlist_insert(%struct.list* %9, i8* %264) #7
...
; <label>:266                                     ; preds = %._crit_edge41
  ...
  %268 = call i64 @TMlist_insert(%struct.list* %9, i8* %267) #7
  call void (...) bitcast (void ()* @RTM_fallback_unlock to void (...)*)() #7
  br label %269
...
; <label>:273                                     ; preds = %269, %._crit_edge, %._crit_edge.thread
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  call void @llvm.x86.sse2.pause() #7
  %83 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
  %84 = icmp eq i64 %83, 0
...
; <label>:87                                      ; preds = %._crit_edge
  ...
  %89 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 2, i64 0, i64 2, i64 4294967295) #7, !srcloc !3
...
; <label>:92                                      ; preds = %87
  ...
  %93 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
  %94 = icmp eq i64 %93, 0
...
; <label>:96                                      ; preds = %95, %92, %86
  ...
  %97 = call i64 @TMlist_iter_hasNext(%struct.list_node** nonnull %it.i, %struct.list* %17) #16
  %98 = icmp eq i64 %97, 0
  br i1 %98, label %TMpopTask.exit, label %99

; <label>:99                                      ; preds = %96
  %100 = call i8* @TMlist_iter_next(%struct.list_node** nonnull %it.i, %struct.list* %17) #7
  %101 = bitcast i8* %100 to %struct.learner_task*
  %102 = call i64 @TMlist_remove(%struct.list* %17, i8* %100) #7
...
.outer40:                                         ; preds = %123, %110
  ...
  %117 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph90:                                         ; preds = %.lr.ph90, %.lr.ph90.preheader
  call void @llvm.x86.sse2.pause() #7
  %119 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:123                                     ; preds = %._crit_edge91
  ...
  %125 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 3, i64 0, i64 3, i64 4294967295) #7, !srcloc !3
...
; <label>:128                                     ; preds = %123
  ...
  %129 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:133                                     ; preds = %132
  %134 = call i64 @TMnet_hasEdge(%struct.net* %7, i64 %114, i64 %116) #7
  %135 = icmp eq i64 %134, 0
  br i1 %135, label %136, label %143

; <label>:136                                     ; preds = %133
  %137 = call i64 @TMnet_isPath(%struct.net* %7, i64 %116, i64 %114, %struct.bitmap* nonnull %21, %struct.queue* nonnull %25) #7
  %138 = icmp eq i64 %137, 0
  br i1 %138, label %select.unfold, label %143

; <label>:139                                     ; preds = %132
  call void @TMnet_applyOperation(%struct.net* %7, i32 1, i64 %114, i64 %116) #7
  %140 = call i64 @TMnet_isPath(%struct.net* %7, i64 %114, i64 %116, %struct.bitmap* nonnull %21, %struct.queue* nonnull %25) #7
  %141 = icmp eq i64 %140, 0
  call void @TMnet_applyOperation(%struct.net* %7, i32 0, i64 %114, i64 %116) #7
...
select.unfold:                                    ; preds = %139, %136, %132
  call void @TMnet_applyOperation(%struct.net* %7, i32 %112, i64 %114, i64 %116) #7
  br label %143

; <label>:143                                     ; preds = %select.unfold, %139, %136, %133
...
.outer31:                                         ; preds = %156, %.outer31.preheader
  %tries4.0.ph = phi i32 [ %157, %156 ], [ 9, %.outer31.preheader ]
  %150 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:156                                     ; preds = %._crit_edge101
  ...
  %158 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 4, i64 0, i64 4, i64 4294967295) #7, !srcloc !3
...
; <label>:161                                     ; preds = %156
  ...
  %162 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:165                                     ; preds = %164, %161, %155
  %tries4.0.ph310 = phi i32 [ %tries4.0.ph.lcssa309, %161 ], [ %tries4.0.ph.lcssa309, %164 ], [ %tries4.0.ph.lcssa, %155 ]
  call fastcc void @TMpopulateParentQueryVector(%struct.net* %7, i64 %116, %struct.timeval* %32, %struct.vector* %61) #7
  %166 = call i64 @Pvector_copy(%struct.vector* %57, %struct.vector* %61) #7
  %167 = icmp eq i64 %166, 0
...
; <label>:169                                     ; preds = %165
  %170 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %116
  %171 = bitcast %struct.timeval* %170 to i8*
  %172 = call i64 @Pvector_pushBack(%struct.vector* %57, i8* %171) #7
...
TMpopulateQueryVectors.exit:                      ; preds = %169
  ...
  %175 = call i64 @vector_getSize(%struct.vector* %61) #7
  %176 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %116, i32 1
  store i64 0, i64* %176, align 8
  %177 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %175, %struct.adtree* %9, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7
  %178 = fadd float %177, 0.000000e+00
  store i64 1, i64* %176, align 8
  %179 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %175, %struct.adtree* %9, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7
...
.outer29:                                         ; preds = %193, %.outer29.preheader
  %tries6.0.ph = phi i32 [ %194, %193 ], [ 9, %.outer29.preheader ]
  %188 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph102:                                        ; preds = %.lr.ph102, %.lr.ph102.preheader
  call void @llvm.x86.sse2.pause() #7
  %190 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:193                                     ; preds = %._crit_edge103
  ...
  %195 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 5, i64 0, i64 5, i64 4294967295) #7, !srcloc !3
  %196 = trunc i64 %195 to i32
  %197 = icmp eq i32 %196, -1
  br i1 %197, label %198, label %.outer29

; <label>:198                                     ; preds = %193
  %199 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph96:                                         ; preds = %.lr.ph96.preheader, %.lr.ph96
  call void @llvm.x86.sse2.pause() #7
  %208 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:212                                     ; preds = %._crit_edge97
  ...
  %214 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 6, i64 0, i64 6, i64 4294967295) #7, !srcloc !3
  %215 = trunc i64 %214 to i32
  %216 = icmp eq i32 %215, -1
  br i1 %216, label %219, label %.outer35

.outer35:                                         ; preds = %212, %.outer35.preheader
  %tries8.0.ph = phi i32 [ %213, %212 ], [ 9, %.outer35.preheader ]
  %217 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:219                                     ; preds = %212
  ...
  %220 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:223                                     ; preds = %222, %219, %211
  %tries8.0.ph308 = phi i32 [ %tries8.0.ph.lcssa307, %219 ], [ %tries8.0.ph.lcssa307, %222 ], [ %tries8.0.ph.lcssa, %211 ]
  call fastcc void @TMpopulateParentQueryVector(%struct.net* %7, i64 %114, %struct.timeval* %32, %struct.vector* %61) #7
  %224 = call i64 @Pvector_copy(%struct.vector* %57, %struct.vector* %61) #7
...
; <label>:227                                     ; preds = %223
  %228 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %114
  %229 = bitcast %struct.timeval* %228 to i8*
  %230 = call i64 @Pvector_pushBack(%struct.vector* %57, i8* %229) #7
...
TMpopulateQueryVectors.exit6:                     ; preds = %227
  call void @vector_sort(%struct.vector* %57, i32 (i8*, i8*)* nonnull @compareQuery) #7
  %233 = call i64 @vector_getSize(%struct.vector* %61) #7
  %234 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %114, i32 1
  store i64 0, i64* %234, align 8
  %235 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %233, %struct.adtree* %9, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7
  %236 = fadd float %235, 0.000000e+00
  store i64 1, i64* %234, align 8
  %237 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %233, %struct.adtree* %9, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7
...
.outer33:                                         ; preds = %251, %.outer33.preheader
  %tries10.0.ph = phi i32 [ %252, %251 ], [ 9, %.outer33.preheader ]
  %246 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph98:                                         ; preds = %.lr.ph98, %.lr.ph98.preheader
  call void @llvm.x86.sse2.pause() #7
  %248 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:251                                     ; preds = %._crit_edge99
  ...
  %253 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 7, i64 0, i64 7, i64 4294967295) #7, !srcloc !3
  %254 = trunc i64 %253 to i32
  %255 = icmp eq i32 %254, -1
  br i1 %255, label %256, label %.outer33

; <label>:256                                     ; preds = %251
  %257 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph92:                                         ; preds = %.lr.ph92.preheader, %.lr.ph92
  call void @llvm.x86.sse2.pause() #7
  %266 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:270                                     ; preds = %._crit_edge93
  ...
  %272 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 8, i64 0, i64 8, i64 4294967295) #7, !srcloc !3
  %273 = trunc i64 %272 to i32
  %274 = icmp eq i32 %273, -1
  br i1 %274, label %277, label %.outer39

.outer39:                                         ; preds = %270, %.outer39.preheader
  %tries13.0.ph = phi i32 [ %271, %270 ], [ 9, %.outer39.preheader ]
  %275 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:285                                     ; preds = %281
  %286 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %114
  %287 = bitcast %struct.timeval* %286 to i8*
  %288 = call i64 @Pvector_pushBack(%struct.vector* %57, i8* %287) #7
...
TMpopulateQueryVectors.exit7:                     ; preds = %285
  call void @vector_sort(%struct.vector* %57, i32 (i8*, i8*)* nonnull @compareQuery) #7
  %291 = call i64 @vector_getSize(%struct.vector* %61) #7
  %292 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %114, i32 1
  store i64 0, i64* %292, align 8
  %293 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %291, %struct.adtree* %9, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7
  %294 = fadd float %293, 0.000000e+00
  store i64 1, i64* %292, align 8
  %295 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %291, %struct.adtree* %9, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7
...
.outer37:                                         ; preds = %310, %.outer37.preheader
  %tries16.0.ph = phi i32 [ %311, %310 ], [ 9, %.outer37.preheader ]
  %304 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph94:                                         ; preds = %.lr.ph94, %.lr.ph94.preheader
  call void @llvm.x86.sse2.pause() #7
  %306 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:310                                     ; preds = %._crit_edge95
  ...
  %312 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 9, i64 0, i64 9, i64 4294967295) #7, !srcloc !3
...
; <label>:315                                     ; preds = %310
  ...
  %316 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:323                                     ; preds = %319
  %324 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %116
  %325 = bitcast %struct.timeval* %324 to i8*
  %326 = call i64 @Pvector_pushBack(%struct.vector* %57, i8* %325) #7
...
TMpopulateQueryVectors.exit8:                     ; preds = %323
  call void @vector_sort(%struct.vector* %57, i32 (i8*, i8*)* nonnull @compareQuery) #7
  %329 = call i64 @vector_getSize(%struct.vector* %61) #7
  %330 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %116, i32 1
  store i64 0, i64* %330, align 8
  %331 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %329, %struct.adtree* %9, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7
  %332 = fadd float %331, 0.000000e+00
  store i64 1, i64* %330, align 8
  %333 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %329, %struct.adtree* %9, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7
...
; <label>:343                                     ; preds = %341, %340, %263, %260, %205, %202, %148
...
.outer28:                                         ; preds = %349, %343
  ...
  %344 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph104:                                        ; preds = %.lr.ph104, %.lr.ph104.preheader
  call void @llvm.x86.sse2.pause() #7
  %346 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:349                                     ; preds = %._crit_edge105
  ...
  %351 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 10, i64 0, i64 10, i64 4294967295) #7, !srcloc !3
  %352 = trunc i64 %351 to i32
  %353 = icmp eq i32 %352, -1
  br i1 %353, label %354, label %.outer28

; <label>:354                                     ; preds = %349
  %355 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.outer27:                                         ; preds = %379, %366
  ...
  %373 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph106:                                        ; preds = %.lr.ph106, %.lr.ph106.preheader
  call void @llvm.x86.sse2.pause() #7
  %375 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:379                                     ; preds = %._crit_edge107
  ...
  %381 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 11, i64 0, i64 11, i64 4294967295) #7, !srcloc !3
...
; <label>:384                                     ; preds = %379
  ...
  %385 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:388                                     ; preds = %387, %384, %378
  ...
  %389 = load %struct.adtree*, %struct.adtree** %8, align 8, !noalias !8
  %390 = load %struct.net*, %struct.net** %6, align 8, !noalias !8
  %391 = load float*, float** %13, align 8, !noalias !8
  call fastcc void @TMpopulateParentQueryVector(%struct.net* %390, i64 %116, %struct.timeval* %32, %struct.vector* %61) #7, !noalias !8
  %392 = call i64 @Pvector_copy(%struct.vector* nonnull %65, %struct.vector* %61) #7, !noalias !8
...
; <label>:395                                     ; preds = %388
  %396 = call i64 @Pvector_copy(%struct.vector* nonnull %69, %struct.vector* nonnull %65) #7, !noalias !8
...
; <label>:399                                     ; preds = %395
  %400 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %116
  %401 = bitcast %struct.timeval* %400 to i8*
  %402 = call i64 @Pvector_pushBack(%struct.vector* nonnull %69, i8* %401) #7, !noalias !8
...
; <label>:405                                     ; preds = %399
  ...
  %408 = load float, float* %407, align 4, !noalias !8
  %409 = call i64 @TMnet_findDescendants(%struct.net* %390, i64 %116, %struct.bitmap* nonnull %21, %struct.queue* nonnull %25) #7, !noalias !8
...
; <label>:412                                     ; preds = %405
  %413 = call %struct.list* @net_getParentIdListPtr(%struct.net* %390, i64 %116) #7, !noalias !8
  %414 = load i64, i64* @global_maxNumEdgeLearned, align 8, !noalias !8
  %415 = icmp slt i64 %414, 0
  br i1 %415, label %419, label %416

; <label>:416                                     ; preds = %412
  %417 = call i64 @TMlist_getSize(%struct.list* %413) #7, !noalias !8
  %418 = icmp sgt i64 %417, %414
  br i1 %418, label %.loopexit.i, label %419

; <label>:419                                     ; preds = %416, %412
  call void @TMlist_iter_reset(%struct.list_node** nonnull %it.i9, %struct.list* %413) #7, !noalias !8
  %420 = call i64 @TMlist_iter_hasNext(%struct.list_node** nonnull %it.i9, %struct.list* %413) #16, !noalias !8
...
.preheader.i:                                     ; preds = %.preheader.i.loopexit, %419
  %422 = call i64 @bitmap_findClear(%struct.bitmap* nonnull %21, i64 0) #7, !noalias !8
  %423 = icmp sgt i64 %422, -1
  br i1 %423, label %.lr.ph.lr.ph.i, label %.loopexit.i

.lr.ph.lr.ph.i:                                   ; preds = %.preheader.i
  %424 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %116, i32 1
  br label %.lr.ph.i

.lr.ph22.i:                                       ; preds = %.lr.ph22.i, %.lr.ph22.i.preheader
  %425 = call i8* @TMlist_iter_next(%struct.list_node** nonnull %it.i9, %struct.list* %413) #7, !noalias !8
  %426 = ptrtoint i8* %425 to i64
  %427 = call i64 @bitmap_set(%struct.bitmap* nonnull %21, i64 %426) #7, !noalias !8
  %428 = call i64 @TMlist_iter_hasNext(%struct.list_node** nonnull %it.i9, %struct.list* %413) #16, !noalias !8
...
.backedge.i:                                      ; preds = %454, %430
  ...
  %434 = call i64 @bitmap_findClear(%struct.bitmap* nonnull %21, i64 %433) #7, !noalias !8
  %435 = icmp sgt i64 %434, -1
  br i1 %435, label %430, label %.loopexit.i.loopexit

; <label>:436                                     ; preds = %430
  %437 = call i64 @Pvector_copy(%struct.vector* %57, %struct.vector* nonnull %69) #7, !noalias !8
...
; <label>:440                                     ; preds = %436
  %441 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %431
  %442 = bitcast %struct.timeval* %441 to i8*
  %443 = call i64 @Pvector_pushBack(%struct.vector* %57, i8* %442) #7, !noalias !8
...
; <label>:446                                     ; preds = %440
  call void @vector_sort(%struct.vector* %57, i32 (i8*, i8*)* nonnull @compareQuery) #7, !noalias !8
  %447 = call i64 @Pvector_copy(%struct.vector* %61, %struct.vector* nonnull %65) #7, !noalias !8
...
; <label>:450                                     ; preds = %446
  %451 = call i64 @Pvector_pushBack(%struct.vector* %61, i8* %442) #7, !noalias !8
...
; <label>:454                                     ; preds = %450
  ...
  %455 = call i64 @vector_getSize(%struct.vector* %61) #7, !noalias !8
  store i64 0, i64* %424, align 8, !noalias !8
  %456 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %455, %struct.adtree* %389, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7, !noalias !8
  %457 = fadd float %456, 0.000000e+00
  store i64 1, i64* %424, align 8, !noalias !8
  %458 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %455, %struct.adtree* %389, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7, !noalias !8
...
.outer.i:                                         ; preds = %454
  ...
  %463 = call i64 @bitmap_findClear(%struct.bitmap* nonnull %21, i64 %462) #7, !noalias !8
...
; <label>:468                                     ; preds = %.loopexit.i
  ...
  %470 = load i64, i64* %469, align 8, !noalias !8
  %471 = call i64 @TMlist_getSize(%struct.list* %413) #7, !noalias !8
  %472 = add nsw i64 %471, 1
  %473 = load i64, i64* @global_insertPenalty, align 8, !noalias !8
...
TMfindBestInsertTask.exit:                        ; preds = %468, %.loopexit.i
...
.outer25:                                         ; preds = %501, %494
  ...
  %495 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph108:                                        ; preds = %.lr.ph108, %.lr.ph108.preheader
  call void @llvm.x86.sse2.pause() #7
  %497 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:501                                     ; preds = %._crit_edge109
  ...
  %503 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 12, i64 0, i64 12, i64 4294967295) #7, !srcloc !3
...
; <label>:506                                     ; preds = %501
  ...
  %507 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:510                                     ; preds = %509, %506, %500
  %tries25.0.ph330 = phi i32 [ %tries25.0.ph.lcssa329, %506 ], [ %tries25.0.ph.lcssa329, %509 ], [ %tries25.0.ph.lcssa, %500 ]
  %511 = load %struct.adtree*, %struct.adtree** %8, align 8, !noalias !11
  %512 = load %struct.net*, %struct.net** %6, align 8, !noalias !11
  %513 = load float*, float** %13, align 8, !noalias !11
  call fastcc void @TMpopulateParentQueryVector(%struct.net* %512, i64 %116, %struct.timeval* %32, %struct.vector* nonnull %65) #7, !noalias !11
  %514 = call i64 @vector_getSize(%struct.vector* nonnull %65) #7, !noalias !11
  %515 = getelementptr inbounds float, float* %513, i64 %116
  %516 = load float, float* %515, align 4, !noalias !11
  %517 = icmp sgt i64 %514, 0
  br i1 %517, label %.lr.ph13.i, label %._crit_edge14.i

.lr.ph13.i:                                       ; preds = %510
  %518 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %116, i32 1
  br label %.lr.ph.us.i
...
.lr.ph.us.i:                                      ; preds = %525, %.lr.ph13.i
  ...
  %519 = call i8* @vector_at(%struct.vector* nonnull %65, i64 %i.09.us.i) #7, !noalias !11
  %520 = bitcast i8* %519 to i64*
  %521 = load i64, i64* %520, align 8, !noalias !11
  call void @vector_clear(%struct.vector* %61) #7, !noalias !11
  br label %535

; <label>:522                                     ; preds = %._crit_edge.us.i
  %523 = call i64 @Pvector_pushBack(%struct.vector* %57, i8* %401) #7, !noalias !11
...
; <label>:525                                     ; preds = %522
  ...
  %526 = call i64 @vector_getSize(%struct.vector* %61) #7, !noalias !11
  store i64 0, i64* %518, align 8, !noalias !11
  %527 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %526, %struct.adtree* %511, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7, !noalias !11
  %528 = fadd float %527, 0.000000e+00
  store i64 1, i64* %518, align 8, !noalias !11
  %529 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %526, %struct.adtree* %511, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7, !noalias !11
  ...
  br i1 %534, label %.lr.ph.us.i, label %._crit_edge14.i.loopexit, !llvm.loop !14
...
; <label>:537                                     ; preds = %535
  %538 = call i8* @vector_at(%struct.vector* nonnull %65, i64 %p.08.us.i) #7, !noalias !11
  %539 = bitcast i8* %538 to i64*
  %540 = load i64, i64* %539, align 8, !noalias !11
  %541 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %540
  %542 = bitcast %struct.timeval* %541 to i8*
  %543 = call i64 @Pvector_pushBack(%struct.vector* %61, i8* %542) #7, !noalias !11
...
._crit_edge.us.i:                                 ; preds = %545
  %548 = call i64 @Pvector_copy(%struct.vector* %57, %struct.vector* %61) #7, !noalias !11
...
; <label>:552                                     ; preds = %._crit_edge14.i
  ...
  %554 = load i64, i64* %553, align 8, !noalias !11
...
TMfindBestRemoveTask.exit:                        ; preds = %552, %._crit_edge14.i
...
.outer24:                                         ; preds = %582, %575
  ...
  %576 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph110:                                        ; preds = %.lr.ph110, %.lr.ph110.preheader
  call void @llvm.x86.sse2.pause() #7
  %578 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:582                                     ; preds = %._crit_edge111
  ...
  %584 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 13, i64 0, i64 13, i64 4294967295) #7, !srcloc !3
...
; <label>:587                                     ; preds = %582
  ...
  %588 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:591                                     ; preds = %590, %587, %581
  %tries27.0.ph332 = phi i32 [ %tries27.0.ph.lcssa331, %587 ], [ %tries27.0.ph.lcssa331, %590 ], [ %tries27.0.ph.lcssa, %581 ]
  %592 = load %struct.adtree*, %struct.adtree** %8, align 8, !noalias !16
  %593 = load %struct.net*, %struct.net** %6, align 8, !noalias !16
  %594 = load float*, float** %13, align 8, !noalias !16
  call fastcc void @TMpopulateParentQueryVector(%struct.net* %593, i64 %116, %struct.timeval* %32, %struct.vector* nonnull %65) #7, !noalias !16
  %595 = call i64 @vector_getSize(%struct.vector* nonnull %65) #7, !noalias !16
  %596 = getelementptr inbounds float, float* %594, i64 %116
  %597 = load float, float* %596, align 4, !noalias !16
  %598 = icmp sgt i64 %595, 0
  br i1 %598, label %.lr.ph20.i, label %TMfindBestReverseTask.exit

.lr.ph20.i:                                       ; preds = %591
  %599 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %116, i32 1
...
.lr.ph.preheader.i:                               ; preds = %649, %.lr.ph20.i
  ...
  %600 = call i8* @vector_at(%struct.vector* nonnull %65, i64 %i.017.i) #7, !noalias !16
  %601 = bitcast i8* %600 to i64*
  %602 = load i64, i64* %601, align 8, !noalias !16
  %603 = getelementptr inbounds float, float* %594, i64 %602
  %604 = load float, float* %603, align 4, !noalias !16
  %605 = fadd float %597, %604
  call fastcc void @TMpopulateParentQueryVector(%struct.net* %593, i64 %602, %struct.timeval* %32, %struct.vector* nonnull %69) #7, !noalias !16
...
; <label>:607                                     ; preds = %.lr.ph.i11
  %608 = call i8* @vector_at(%struct.vector* nonnull %65, i64 %p.016.i) #7, !noalias !16
  %609 = bitcast i8* %608 to i64*
  %610 = load i64, i64* %609, align 8, !noalias !16
  %611 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %610
  %612 = bitcast %struct.timeval* %611 to i8*
  %613 = call i64 @Pvector_pushBack(%struct.vector* %61, i8* %612) #7, !noalias !16
...
._crit_edge.i:                                    ; preds = %616
  %619 = call i64 @Pvector_copy(%struct.vector* %57, %struct.vector* %61) #7, !noalias !16
...
; <label>:622                                     ; preds = %._crit_edge.i
  %623 = call i64 @Pvector_pushBack(%struct.vector* %57, i8* %401) #7, !noalias !16
...
; <label>:626                                     ; preds = %622
  ...
  %627 = call i64 @vector_getSize(%struct.vector* %61) #7, !noalias !16
  store i64 0, i64* %599, align 8, !noalias !16
  %628 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %627, %struct.adtree* %592, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7, !noalias !16
  %629 = fadd float %628, 0.000000e+00
  store i64 1, i64* %599, align 8, !noalias !16
  %630 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %627, %struct.adtree* %592, %struct.timeval* %32, %struct.vector* %57, %struct.vector* %61) #7, !noalias !16
  %631 = fadd float %629, %630
  store i64 -1, i64* %599, align 8, !noalias !16
  %632 = call i64 @Pvector_copy(%struct.vector* %61, %struct.vector* nonnull %69) #7, !noalias !16
...
; <label>:635                                     ; preds = %626
  %636 = call i64 @Pvector_pushBack(%struct.vector* %61, i8* nonnull %401) #7, !noalias !16
...
; <label>:639                                     ; preds = %635
  ...
  %640 = call i64 @Pvector_copy(%struct.vector* %57, %struct.vector* %61) #7, !noalias !16
...
; <label>:643                                     ; preds = %639
  %644 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %602
  %645 = bitcast %struct.timeval* %644 to i8*
  %646 = call i64 @Pvector_pushBack(%struct.vector* %57, i8* %645) #7, !noalias !16
...
; <label>:649                                     ; preds = %643
  call void @vector_sort(%struct.vector* %57, i32 (i8*, i8*)* nonnull @compareQuery) #7, !noalias !16
  %650 = call i64 @vector_getSize(%struct.vector* %61) #7, !noalias !16
  %651 = getelementptr inbounds %struct.timeval, %struct.timeval* %32, i64 %602, i32 1
  store i64 0, i64* %651, align 8, !noalias !16
  %652 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %650, %struct.adtree* %592, %struct.timeval* nonnull %32, %struct.vector* %57, %struct.vector* %61) #7, !noalias !16
  %653 = fadd float %652, 0.000000e+00
  store i64 1, i64* %651, align 8, !noalias !16
  %654 = call fastcc float @computeLocalLogLikelihoodHelper(i64 0, i64 %650, %struct.adtree* %592, %struct.timeval* nonnull %32, %struct.vector* %57, %struct.vector* %61) #7, !noalias !16
  ...
  br i1 %659, label %.lr.ph.preheader.i, label %660, !llvm.loop !19
...
; <label>:662                                     ; preds = %660
  call void @TMnet_applyOperation(%struct.net* %593, i32 1, i64 %bestFromId.1.i12.lcssa, i64 %116) #7, !noalias !16
  %663 = call i64 @TMnet_isPath(%struct.net* %593, i64 %bestFromId.1.i12.lcssa, i64 %116, %struct.bitmap* nonnull %21, %struct.queue* nonnull %25) #7, !noalias !16
  %664 = icmp eq i64 %663, 0
  call void @TMnet_applyOperation(%struct.net* %593, i32 0, i64 %bestFromId.1.i12.lcssa, i64 %116) #7, !noalias !16
...
; <label>:666                                     ; preds = %662
  ...
  %668 = load float, float* %667, align 4, !noalias !16
  %669 = getelementptr inbounds %struct.adtree, %struct.adtree* %592, i64 0, i32 1
  %670 = load i64, i64* %669, align 8, !noalias !16
...
TMfindBestReverseTask.exit:                       ; preds = %666, %662, %660, %591
...
.outer:                                           ; preds = %708, %691
  ...
  %703 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
.lr.ph112:                                        ; preds = %.lr.ph112, %.lr.ph112.preheader
  call void @llvm.x86.sse2.pause() #7
  %705 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:708                                     ; preds = %._crit_edge113
  ...
  %710 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 14, i64 0, i64 14, i64 4294967295) #7, !srcloc !3
  %711 = trunc i64 %710 to i32
  %712 = icmp eq i32 %711, -1
  br i1 %712, label %713, label %.outer

; <label>:713                                     ; preds = %708
  %714 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #7
...
; <label>:717                                     ; preds = %716, %713
  %718 = call i64 @TMlist_insert(%struct.list* %17, i8* %694) #7
  call void asm sideeffect "mov $0,%rcx\0A\09xend \0A\09", "r,~{rcx},~{dirflag},~{fpsr},~{flags}"(i64 14) #7, !srcloc !5
  br label %.backedge.backedge

.backedge.backedge:                               ; preds = %719, %717, %689
  br label %.backedge

; <label>:719                                     ; preds = %._crit_edge113
  call void (...) bitcast (void ()* @RTM_fallback_lock to void (...)*)() #7
  %720 = call i64 @TMlist_insert(%struct.list* %17, i8* %694) #7
  call void (...) bitcast (void ()* @RTM_fallback_unlock to void (...)*)() #7
  br label %.backedge.backedge
