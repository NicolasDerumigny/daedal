...
__kernel__TMfindBestRemoveTask0:                  ; preds = %75, %0
  %bestFromId.0 = phi float [ %26, %0 ], [ %bestFromId.1, %75 ]
  %bestLocalLogLikelihood.0 = phi float [ %28, %0 ], [ %bestLocalLogLikelihood.1, %75 ]
  %i.0 = phi i64 [ 0, %0 ], [ %76, %75 ]
  %31 = icmp slt i64 %i.0, %25
  br i1 %31, label %32, label %77

; <label>:32                                      ; preds = %__kernel__TMfindBestRemoveTask0
  %33 = call i8* @vector_at(%struct.vector* %18, i64 %i.0)
...
; <label>:69                                      ; preds = %66
  ...
  %71 = fcmp ogt float %70, %bestLocalLogLikelihood.0
...
; <label>:74                                      ; preds = %._crit_edge1, %72
  %bestFromId.1 = phi float [ %73, %72 ], [ %bestFromId.0, %._crit_edge1 ]
  %bestLocalLogLikelihood.1 = phi float [ %70, %72 ], [ %bestLocalLogLikelihood.0, %._crit_edge1 ]
  br label %75

; <label>:75                                      ; preds = %74
  %76 = add nsw i64 %i.0, 1
...
; <label>:77                                      ; preds = %__kernel__TMfindBestRemoveTask0
  ...
  %79 = fptosi float %bestFromId.0 to i64
  ...
  %84 = fcmp une float %bestFromId.0, %83
...
; <label>:85                                      ; preds = %77
  ...
  %92 = fadd float %16, %bestLocalLogLikelihood.0
  %93 = fsub float %92, %28
  %94 = fmul float %91, %93
  %95 = fadd float %90, %94
...
__kernel__TMfindBestReverseTask1:                 ; preds = %112, %0
  %bestFromId.0 = phi i64 [ %2, %0 ], [ %bestFromId.1, %112 ]
  %bestLocalLogLikelihood.0 = phi float [ %33, %0 ], [ %bestLocalLogLikelihood.1, %112 ]
  %i.0 = phi i64 [ 0, %0 ], [ %113, %112 ]
  %38 = icmp slt i64 %i.0, %31
  br i1 %38, label %39, label %114

; <label>:39                                      ; preds = %__kernel__TMfindBestReverseTask1
  %40 = call i8* @vector_at(%struct.vector* %22, i64 %i.0)
...
; <label>:111                                     ; preds = %._crit_edge1, %110
  %bestFromId.1 = phi i64 [ %43, %110 ], [ %bestFromId.0, %._crit_edge1 ]
  %bestLocalLogLikelihood.1 = phi float [ %108, %110 ], [ %46, %._crit_edge1 ]
  br label %112
...
; <label>:114                                     ; preds = %__kernel__TMfindBestReverseTask1
  %115 = icmp ne i64 %bestFromId.0, %2
...
; <label>:116                                     ; preds = %114
  call void @TMnet_applyOperation(%struct.net* %28, i32 1, i64 %bestFromId.0, i64 %2)
  %117 = call i64 @TMnet_isPath(%struct.net* %28, i64 %bestFromId.0, i64 %2, %struct.bitmap* %18, %struct.queue* %20)
...
; <label>:120                                     ; preds = %._crit_edge3, %119
  ...
  call void @TMnet_applyOperation(%struct.net* %28, i32 0, i64 %bestFromId.0, i64 %2)
...
; <label>:123                                     ; preds = %._crit_edge4, %122
  %bestFromId.2 = phi i64 [ %bestFromId.0, %._crit_edge4 ], [ %2, %122 ]
  br label %124

; <label>:124                                     ; preds = %._crit_edge2, %123
  %bestFromId.3 = phi i64 [ %bestFromId.2, %123 ], [ %bestFromId.0, %._crit_edge2 ]
  ...
  store i64 %bestFromId.3, i64* %126, align 8
  ...
  %129 = icmp ne i64 %bestFromId.3, %2
...
; <label>:130                                     ; preds = %124
  %131 = getelementptr inbounds float, float* %30, i64 %bestFromId.3
  ...
  %138 = fadd float %16, %bestLocalLogLikelihood.0
