...
; <label>:16                                      ; preds = %4
  call void @__assert_fail(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 102, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @__PRETTY_FUNCTION__.grid_alloc, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %18
...
; <label>:16                                      ; preds = %4
  call void @__assert_fail(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 130, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__PRETTY_FUNCTION__.Pgrid_alloc, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %18
...
; <label>:7                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 173, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__PRETTY_FUNCTION__.grid_copy, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %9
...
; <label>:16                                      ; preds = %9
  call void @__assert_fail(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 174, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__PRETTY_FUNCTION__.grid_copy, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %18
...
; <label>:25                                      ; preds = %18
  call void @__assert_fail(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 175, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__PRETTY_FUNCTION__.grid_copy, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %27
...
define internal void @TMgrid_addPath___kernel__TMgrid_addPath0({ i64, %struct.vector* }*) #5 {
newFuncRoot:
...
__kernel__TMgrid_addPath0:                        ; preds = %newFuncRoot, %10
