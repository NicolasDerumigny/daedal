...
; <label>:28                                      ; preds = %171, %7
  %delta.0 = phi float [ 0.000000e+00, %7 ], [ %delta.1, %171 ]
  %start.0 = phi i32 [ %27, %7 ], [ %162, %171 ]
...
; <label>:37                                      ; preds = %133, %36
  %delta.1 = phi float [ %delta.0, %36 ], [ %delta.2, %133 ]
  %i.0 = phi i32 [ %start.0, %36 ], [ %134, %133 ]
...
; <label>:55                                      ; preds = %82, %52
  %tries.0 = phi i32 [ 9, %52 ], [ %75, %82 ]
  br label %56

; <label>:56                                      ; preds = %73, %55
  %57 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)()
  %58 = icmp ne i64 %57, 0
  %59 = bitcast i64** @RTM_fallBackLock to i8*
  call void @llvm.prefetch(i8* %59, i32 0, i32 3, i32 1)
  %60 = sext i32 %43 to i64
  %61 = getelementptr inbounds i32*, i32** %22, i64 %60
  %62 = bitcast i32** %61 to i8*
  call void @llvm.prefetch(i8* %62, i32 0, i32 3, i32 1)
  %63 = getelementptr { i32, float**, float**, float**, float** }, { i32, float**, float**, float**, float** }* %structArg, i32 0, i32 0
  %64 = bitcast i32* %63 to i8*
  call void @llvm.prefetch(i8* %64, i32 0, i32 3, i32 1)
  %65 = getelementptr { i32, float**, float**, float**, float** }, { i32, float**, float**, float**, float** }* %structArg, i32 0, i32 1
  %66 = bitcast float*** %65 to i8*
  call void @llvm.prefetch(i8* %66, i32 0, i32 3, i32 1)
  %67 = getelementptr { i32, float**, float**, float**, float** }, { i32, float**, float**, float**, float** }* %structArg, i32 0, i32 2
  %68 = bitcast float*** %67 to i8*
  call void @llvm.prefetch(i8* %68, i32 0, i32 3, i32 1)
  %69 = getelementptr { i32, float**, float**, float**, float** }, { i32, float**, float**, float**, float** }* %structArg, i32 0, i32 3
  %70 = bitcast float*** %69 to i8*
  call void @llvm.prefetch(i8* %70, i32 0, i32 3, i32 1)
  %71 = getelementptr { i32, float**, float**, float**, float** }, { i32, float**, float**, float**, float** }* %structArg, i32 0, i32 4
  %72 = bitcast float*** %71 to i8*
  call void @llvm.prefetch(i8* %72, i32 0, i32 3, i32 1)
  br i1 %58, label %73, label %74
...
; <label>:78                                      ; preds = %74
  %79 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 0, i64 0, i64 0, i64 4294967295) #7, !srcloc !3
...
; <label>:83                                      ; preds = %78
  %84 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)()
  %85 = icmp ne i64 %84, 0
...
__kernel__work0.i:                                ; preds = %110, %codeRepl
  %j.0.i = phi i32 [ 0, %codeRepl ], [ %127, %110 ]
  %109 = icmp slt i32 %j.0.i, %loadgep_.i
  br i1 %109, label %110, label %work___kernel__work0_clone.exit

; <label>:110                                     ; preds = %__kernel__work0.i
  %111 = sext i32 %j.0.i to i64
  %112 = load float*, float** %loadgep_2.i, align 8
  %113 = getelementptr inbounds float, float* %112, i64 %111
  %114 = load float, float* %113, align 4
  %115 = sext i32 %j.0.i to i64
  %116 = load float*, float** %loadgep_4.i, align 8
  %117 = getelementptr inbounds float, float* %116, i64 %115
  %118 = load float, float* %117, align 4
  %119 = fadd float %114, %118
  %120 = sext i32 %j.0.i to i64
  %121 = load float*, float** %loadgep_6.i, align 8
  %122 = getelementptr inbounds float, float* %121, i64 %120
  store float %119, float* %122, align 4, !GlobalAlias !5
  %123 = sext i32 %j.0.i to i64
  %124 = load float*, float** %loadgep_8.i, align 8
  %125 = getelementptr inbounds float, float* %124, i64 %123
  %126 = load float, float* %125, align 4
  %127 = add nsw i32 %j.0.i, 1
  br label %__kernel__work0.i, !llvm.loop !6

work___kernel__work0_clone.exit:                  ; preds = %__kernel__work0.i
  br label %128

; <label>:128                                     ; preds = %work___kernel__work0_clone.exit
...
; <label>:133                                     ; preds = %132
  %134 = add nsw i32 %i.0, 1
  br label %37

; <label>:135                                     ; preds = %37
  %136 = add nsw i32 %start.0, 3
...
; <label>:139                                     ; preds = %154, %138
  %tries2.0 = phi i32 [ 9, %138 ], [ %147, %154 ]
  br label %140

; <label>:140                                     ; preds = %145, %139
  ...
  %144 = bitcast i64* @global_i to i8*
  call void @llvm.prefetch(i8* %144, i32 0, i32 3, i32 1)
...
; <label>:150                                     ; preds = %146
  %151 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 1, i64 0, i64 1, i64 4294967295) #7, !srcloc !3
...
; <label>:155                                     ; preds = %150
  %156 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)()
  %157 = icmp ne i64 %156, 0
  br i1 %157, label %158, label %._crit_edge2
...
; <label>:159                                     ; preds = %158, %._crit_edge2
  br label %160

; <label>:160                                     ; preds = %159, %149
  %161 = load i64, i64* @global_i, align 8
  %162 = trunc i64 %161 to i32
  %163 = add nsw i32 %162, 3
  %164 = sext i32 %163 to i64
  store i64 %164, i64* @global_i, align 8
  %165 = load i64, i64* @global_i, align 8
  %166 = icmp sgt i32 %147, 0
...
; <label>:172                                     ; preds = %.loopexit, %170
  %delta.3 = phi float [ %delta.1, %170 ], [ %delta.0, %.loopexit ]
  br label %173

; <label>:173                                     ; preds = %188, %172
  %tries4.0 = phi i32 [ 9, %172 ], [ %181, %188 ]
  br label %174

; <label>:174                                     ; preds = %179, %173
  %175 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)()
  %176 = icmp ne i64 %175, 0
  %177 = bitcast i64** @RTM_fallBackLock to i8*
  call void @llvm.prefetch(i8* %177, i32 0, i32 3, i32 1)
  %178 = bitcast float* @global_delta to i8*
...
; <label>:184                                     ; preds = %180
  %185 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 2, i64 0, i64 2, i64 4294967295) #7, !srcloc !3
...
; <label>:189                                     ; preds = %184
  %190 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)()
  %191 = icmp ne i64 %190, 0
  br i1 %191, label %192, label %._crit_edge3
...
; <label>:193                                     ; preds = %192, %._crit_edge3
  br label %194

; <label>:194                                     ; preds = %193, %183
  %195 = load float, float* @global_delta, align 4
  %196 = fadd float %195, %delta.3
  store float %196, float* @global_delta, align 4
  %197 = load float, float* @global_delta, align 4
...
; <label>:202                                     ; preds = %201
  %203 = call i64 (...) bitcast (i64 ()* @thread_getId to i64 (...)*)()
  %204 = trunc i64 %203 to i32
  %205 = getelementptr inbounds %struct._tm_thread_context_t, %struct._tm_thread_context_t* %3, i32 0, i32 4
  %206 = load i32, i32* %205, align 4
  call void @SimRoiEnd(i32 %204, i32 %206)
  br label %207
