; ModuleID = '../bin/STAMP-kmeans.tm-arg.ll'
...
; <label>:35                                      ; preds = %.backedge, %.lr.ph23
  ...
  %start.020 = phi i32 [ %30, %.lr.ph23 ], [ %159, %.backedge ]
...
.outer1.us:                                       ; preds = %52, %.lr.ph16.split.us
  ...
  %94 = icmp eq i64 %93, 0
  %95 = bitcast i64** @RTM_fallBackLock to i8*
...
._crit_edge12.us:                                 ; preds = %._crit_edge12.us.unr-lcssa, %.lr.ph11.us.split
  %102 = icmp sgt i32 %tries.0.ph.us63, 1
  br i1 %102, label %75, label %74

.lr.ph16.split:                                   ; preds = %138, %.lr.ph16.split.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %138 ], [ %40, %.lr.ph16.split.preheader ]
  %delta.114 = phi float [ %delta.1., %138 ], [ %delta.021, %.lr.ph16.split.preheader ]
  %103 = getelementptr inbounds float*, float** %6, i64 %indvars.iv
  %104 = load float*, float** %103, align 8
  %105 = tail call i32 @common_findNearestPoint(float* %104, i32 %10, float** %21, i32 %15) #6
  %106 = getelementptr inbounds i32, i32* %18, i64 %indvars.iv
  %107 = load i32, i32* %106, align 4
  %108 = icmp eq i32 %107, %105
  %109 = fadd float %delta.114, 1.000000e+00
  %delta.1. = select i1 %108, float %delta.114, float %109
  store i32 %105, i32* %106, align 4
  br label %.outer1

.outer1:                                          ; preds = %120, %.lr.ph16.split
  %tries.0.ph = phi i32 [ %121, %120 ], [ 9, %.lr.ph16.split ]
  %110 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %111 = icmp eq i64 %110, 0
  %112 = bitcast i64** @RTM_fallBackLock to i8*
  ...
  call void @llvm.prefetch(i8* %115, i32 0, i32 3, i32 1)
  br i1 %111, label %._crit_edge8, label %.lr.ph7.preheader
...
.lr.ph7:                                          ; preds = %.lr.ph7, %.lr.ph7.preheader
  tail call void @llvm.x86.sse2.pause() #6
  %116 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %117 = icmp eq i64 %116, 0
  br i1 %117, label %._crit_edge8.loopexit, label %.lr.ph7

._crit_edge8.loopexit:                            ; preds = %.lr.ph7
  br label %._crit_edge8

._crit_edge8:                                     ; preds = %._crit_edge8.loopexit, %.outer1
  %118 = icmp slt i32 %tries.0.ph, 2
  br i1 %118, label %119, label %120

; <label>:119                                     ; preds = %._crit_edge8
  %tries.0.ph.lcssa = phi i32 [ %tries.0.ph, %._crit_edge8 ]
  tail call void (...) bitcast (void ()* @RTM_fallback_lock to void (...)*)() #6
  br label %129

; <label>:120                                     ; preds = %._crit_edge8
  %121 = add nsw i32 %tries.0.ph, -1
  %122 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 0, i64 0, i64 0, i64 4294967295) #6, !srcloc !15
  %123 = trunc i64 %122 to i32
  %124 = icmp eq i32 %123, -1
  br i1 %124, label %125, label %.outer1

; <label>:125                                     ; preds = %120
  %tries.0.ph.lcssa60 = phi i32 [ %tries.0.ph, %120 ]
  %126 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
...
; <label>:129                                     ; preds = %128, %125, %119
  %tries.0.ph61 = phi i32 [ %tries.0.ph.lcssa60, %125 ], [ %tries.0.ph.lcssa60, %128 ], [ %tries.0.ph.lcssa, %119 ]
  ...
  %135 = icmp sgt i32 %tries.0.ph61, 1
...
; <label>:138                                     ; preds = %137, %136
  ...
  %139 = icmp slt i64 %indvars.iv.next, %41
  br i1 %139, label %.lr.ph16.split, label %._crit_edge17.loopexit53

._crit_edge17.loopexit:                           ; preds = %76
  %delta.1..us.lcssa = phi float [ %delta.1..us, %76 ]
  br label %._crit_edge17

._crit_edge17.loopexit53:                         ; preds = %138
  %delta.1..lcssa = phi float [ %delta.1., %138 ]
  br label %._crit_edge17
...
.outer2:                                          ; preds = %148, %.outer2.preheader
  %tries2.0.ph = phi i32 [ %149, %148 ], [ 9, %.outer2.preheader ]
  %140 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %141 = icmp eq i64 %140, 0
  %142 = bitcast i64** @RTM_fallBackLock to i8*
  call void @llvm.prefetch(i8* %142, i32 0, i32 3, i32 1)
  %143 = bitcast i64* @global_i to i8*
  call void @llvm.prefetch(i8* %143, i32 0, i32 3, i32 1)
  br i1 %141, label %._crit_edge19, label %.lr.ph18.preheader
...
.lr.ph18:                                         ; preds = %.lr.ph18, %.lr.ph18.preheader
  tail call void @llvm.x86.sse2.pause() #6
  %144 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %145 = icmp eq i64 %144, 0
  br i1 %145, label %._crit_edge19.loopexit, label %.lr.ph18

._crit_edge19.loopexit:                           ; preds = %.lr.ph18
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %._crit_edge19.loopexit, %.outer2
  %146 = icmp slt i32 %tries2.0.ph, 2
  br i1 %146, label %147, label %148

; <label>:147                                     ; preds = %._crit_edge19
  %tries2.0.ph.lcssa = phi i32 [ %tries2.0.ph, %._crit_edge19 ]
  tail call void (...) bitcast (void ()* @RTM_fallback_lock to void (...)*)() #6
  br label %157

; <label>:148                                     ; preds = %._crit_edge19
  %149 = add nsw i32 %tries2.0.ph, -1
  %150 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 1, i64 0, i64 1, i64 4294967295) #6, !srcloc !15
  %151 = trunc i64 %150 to i32
  %152 = icmp eq i32 %151, -1
  br i1 %152, label %153, label %.outer2

; <label>:153                                     ; preds = %148
  %tries2.0.ph.lcssa64 = phi i32 [ %tries2.0.ph, %148 ]
  %154 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
...
; <label>:157                                     ; preds = %156, %153, %147
  %tries2.0.ph65 = phi i32 [ %tries2.0.ph.lcssa64, %153 ], [ %tries2.0.ph.lcssa64, %156 ], [ %tries2.0.ph.lcssa, %147 ]
  %158 = load i64, i64* @global_i, align 8
  %159 = trunc i64 %158 to i32
  %160 = shl i64 %158, 32
  %sext = add i64 %160, 12884901888
  %161 = ashr exact i64 %sext, 32
  store i64 %161, i64* @global_i, align 8
  %162 = icmp sgt i32 %tries2.0.ph65, 1
...
.backedge:                                        ; preds = %165, %163
  %164 = icmp slt i32 %159, %12
  br i1 %164, label %35, label %._crit_edge24.loopexit
...
.outer:                                           ; preds = %173, %._crit_edge24
  %tries4.0.ph = phi i32 [ %174, %173 ], [ 9, %._crit_edge24 ]
  %166 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %167 = icmp eq i64 %166, 0
  %168 = bitcast i64** @RTM_fallBackLock to i8*
  call void @llvm.prefetch(i8* %168, i32 0, i32 3, i32 1)
  %169 = bitcast float* @global_delta to i8*
  call void @llvm.prefetch(i8* %169, i32 0, i32 3, i32 1)
  br i1 %167, label %._crit_edge, label %.lr.ph.preheader
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  tail call void @llvm.x86.sse2.pause() #6
  %170 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
  %171 = icmp eq i64 %170, 0
  br i1 %171, label %._crit_edge.loopexit, label %.lr.ph

._crit_edge.loopexit:                             ; preds = %.lr.ph
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.outer
  %172 = icmp slt i32 %tries4.0.ph, 2
  br i1 %172, label %185, label %173

; <label>:173                                     ; preds = %._crit_edge
  %174 = add nsw i32 %tries4.0.ph, -1
  %175 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 2, i64 0, i64 2, i64 4294967295) #6, !srcloc !15
  %176 = trunc i64 %175 to i32
  %177 = icmp eq i32 %176, -1
  br i1 %177, label %178, label %.outer

; <label>:178                                     ; preds = %173
  %179 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #6
...
; <label>:182                                     ; preds = %181, %178
  %183 = load float, float* @global_delta, align 4
  %184 = fadd float %delta.3, %183
  store float %184, float* @global_delta, align 4
...
; <label>:185                                     ; preds = %._crit_edge
  tail call void (...) bitcast (void ()* @RTM_fallback_lock to void (...)*)() #6
  %186 = load float, float* @global_delta, align 4
  %187 = fadd float %delta.3, %186
  store float %187, float* @global_delta, align 4
  tail call void (...) bitcast (void ()* @RTM_fallback_unlock to void (...)*)() #6
  br label %188

; <label>:188                                     ; preds = %185, %182
  %189 = tail call i64 (...) bitcast (i64 ()* @thread_getId to i64 (...)*)() #6
  %190 = trunc i64 %189 to i32
  %191 = getelementptr inbounds %struct._tm_thread_context_t, %struct._tm_thread_context_t* %2, i64 %1, i32 4
  %192 = load i32, i32* %191, align 4
  tail call void @SimRoiEnd(i32 %190, i32 %192) #6
  ret void
}
...
; Function Attrs: argmemonly nounwind
declare void @llvm.prefetch(i8* nocapture, i32, i32, i32) #8
