...
__kernel__work0:                                  ; preds = %113, %74
  %j.0 = phi i32 [ 0, %74 ], [ %114, %113 ]
  %95 = icmp slt i32 %j.0, %12
  br i1 %95, label %96, label %115

; <label>:96                                      ; preds = %__kernel__work0
  %97 = sext i32 %j.0 to i64
