...
; <label>:129                                     ; preds = %132, %128
  %130 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)()
...
; <label>:137                                     ; preds = %133
  %138 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 1, i64 0, i64 1, i64 4294967295) #4, !srcloc !1
...
; <label>:142                                     ; preds = %137
  %143 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)()
...
; <label>:188                                     ; preds = %191, %187
  %189 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)()
...
; <label>:196                                     ; preds = %192
  %197 = call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 2, i64 0, i64 2, i64 4294967295) #4, !srcloc !1
...
; <label>:201                                     ; preds = %196
  %202 = call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)()
...
; <label>:221                                     ; preds = %220
  %222 = call i64 (...) bitcast (i64 ()* @thread_getId to i64 (...)*)()
...
define internal i1 @client_run___kernel__client_run1({ i64, i64*, i64*, %struct.manager*, [3 x i64]*, [3 x i64]*, i64 }*) #5 {
newFuncRoot:
...
__kernel__client_run1:                            ; preds = %33, %newFuncRoot
...
; <label>:7                                       ; preds = %2
  %8 = call i64 @manager_queryRoom(%struct.manager* %loadgep_6, i64 %6) #18
  %9 = icmp sge i64 %8, 0
...
; <label>:13                                      ; preds = %2
  %14 = call i64 @manager_queryFlight(%struct.manager* %loadgep_6, i64 %6) #18
...
; <label>:19                                      ; preds = %2
  %20 = call i64 @manager_queryCar(%struct.manager* %loadgep_6, i64 %6) #18
...
; <label>:33                                      ; preds = %32
  ...
  br label %__kernel__client_run1, !llvm.loop !4
}
...
; Function Attrs: alwaysinline nounwind
define internal i16 @client_run___kernel__client_run0({ i64, i64*, i64*, i64*, %struct.manager*, i64* }*) #5 {
newFuncRoot:
...
__kernel__client_run0:                            ; preds = %29, %newFuncRoot
...
__kernel__customer_getBill0:                      ; preds = %3, %newFuncRoot
  %bill.0 = phi i64 [ 0, %newFuncRoot ], [ %8, %3 ]
  %1 = call i64 @TMlist_iter_hasNext(%struct.list_node** %loadgep_it, %struct.list* %loadgep_) #18
  %2 = icmp ne i64 %1, 0
...
; <label>:3                                       ; preds = %__kernel__customer_getBill0
  ...
  br label %__kernel__customer_getBill0, !llvm.loop !8
}
...
; <label>:20                                      ; preds = %13
  call void asm sideeffect ".byte 0xc6,0xf8,${0:P}", "i,~{dirflag},~{fpsr},~{flags}"(i32 171) #4, !srcloc !10
  br label %21
...
codeRepl:                                         ; preds = %8
  ...
  call void @manager_deleteCustomer___kernel__manager_deleteCustomer0({ %struct.list_node**, %struct.list*, [3 x %struct.rbtree*]* }* %structArg)
  br label %20

; <label>:20                                      ; preds = %codeRepl
  %21 = getelementptr inbounds %struct.manager, %struct.manager* %managerPtr, i32 0, i32 3
  %22 = load %struct.rbtree*, %struct.rbtree** %21, align 8
  %23 = inttoptr i64 %customerId to i8*
  %24 = call i64 @TMrbtree_delete(%struct.rbtree* %22, i8* %23)
  %25 = icmp eq i64 %24, 0
  br i1 %25, label %26, label %._crit_edge2
...
; Function Attrs: alwaysinline nounwind
define internal void @manager_deleteCustomer___kernel__manager_deleteCustomer0({ %struct.list_node**, %struct.list*, [3 x %struct.rbtree*]* }*) #5 {
newFuncRoot:
  %gep_it = getelementptr { %struct.list_node**, %struct.list*, [3 x %struct.rbtree*]* }, { %struct.list_node**, %struct.list*, [3 x %struct.rbtree*]* }* %0, i32 0, i32 0
  %loadgep_it = load %struct.list_node**, %struct.list_node*** %gep_it
  %gep_ = getelementptr { %struct.list_node**, %struct.list*, [3 x %struct.rbtree*]* }, { %struct.list_node**, %struct.list*, [3 x %struct.rbtree*]* }* %0, i32 0, i32 1
  %loadgep_ = load %struct.list*, %struct.list** %gep_
  %gep_reservationTables = getelementptr { %struct.list_node**, %struct.list*, [3 x %struct.rbtree*]* }, { %struct.list_node**, %struct.list*, [3 x %struct.rbtree*]* }* %0, i32 0, i32 2
  %loadgep_reservationTables = load [3 x %struct.rbtree*]*, [3 x %struct.rbtree*]** %gep_reservationTables
  br label %__kernel__manager_deleteCustomer0

.exitStub:                                        ; preds = %__kernel__manager_deleteCustomer0
  ret void

__kernel__manager_deleteCustomer0:                ; preds = %22, %newFuncRoot
  %1 = call i64 @TMlist_iter_hasNext(%struct.list_node** %loadgep_it, %struct.list* %loadgep_) #18
  %2 = icmp ne i64 %1, 0
  br i1 %2, label %3, label %.exitStub

; <label>:3                                       ; preds = %__kernel__manager_deleteCustomer0
  %4 = call i8* @TMlist_iter_next(%struct.list_node** %loadgep_it, %struct.list* %loadgep_)
  %5 = bitcast i8* %4 to %struct.reservation_info*
  %6 = getelementptr inbounds %struct.reservation_info, %struct.reservation_info* %5, i32 0, i32 0
  %7 = load i32, i32* %6, align 8
  %8 = zext i32 %7 to i64
  %9 = getelementptr inbounds [3 x %struct.rbtree*], [3 x %struct.rbtree*]* %loadgep_reservationTables, i64 0, i64 %8
  %10 = load %struct.rbtree*, %struct.rbtree** %9, align 8
  %11 = getelementptr inbounds %struct.reservation_info, %struct.reservation_info* %5, i32 0, i32 1
  %12 = load i64, i64* %11, align 8
  %13 = inttoptr i64 %12 to i8*
  %14 = call i8* @TMrbtree_get(%struct.rbtree* %10, i8* %13)
  %15 = bitcast i8* %14 to %struct.reservation*
  %16 = icmp eq %struct.reservation* %15, null
...
; <label>:18                                      ; preds = %17, %._crit_edge
  %19 = call i64 @reservation_cancel(%struct.reservation* %15)
  %20 = icmp eq i64 %19, 0
...
; <label>:22                                      ; preds = %21, %._crit_edge1
  call void @reservation_info_free(%struct.reservation_info* %5)
  br label %__kernel__manager_deleteCustomer0, !llvm.loop !14
}

; Function Attrs: nounwind readonly uwtable
define i64 @manager_queryCar(%struct.manager* %managerPtr, i64 %carId) #7 {
  %"reg2mem alloca point" = bitcast i32 0 to i32
  %1 = getelementptr inbounds %struct.manager, %struct.manager* %managerPtr, i32 0, i32 0
  %2 = load %struct.rbtree*, %struct.rbtree** %1, align 8
...
; Function Attrs: nounwind readonly uwtable
define i64 @manager_queryRoom(%struct.manager* %managerPtr, i64 %roomId) #7 {
  %"reg2mem alloca point" = bitcast i32 0 to i32
  %1 = getelementptr inbounds %struct.manager, %struct.manager* %managerPtr, i32 0, i32 1
  %2 = load %struct.rbtree*, %struct.rbtree** %1, align 8
...
; Function Attrs: nounwind readonly uwtable
define i64 @manager_queryFlight(%struct.manager* %managerPtr, i64 %flightId) #7 {
  %"reg2mem alloca point" = bitcast i32 0 to i32
  %1 = getelementptr inbounds %struct.manager, %struct.manager* %managerPtr, i32 0, i32 2
  %2 = load %struct.rbtree*, %struct.rbtree** %1, align 8
...
; <label>:24                                      ; preds = %21
  call void asm sideeffect ".byte 0xc6,0xf8,${0:P}", "i,~{dirflag},~{fpsr},~{flags}"(i32 171) #4, !srcloc !15
  br label %25
...
; <label>:23                                      ; preds = %22, %20
  %24 = call { i32, i32, i32, i32 } asm "  xchgq  %rbx,${1:q}\0A  cpuid\0A  xchgq  %rbx,${1:q}", "={ax},=r,={cx},={dx},0,2,~{dirflag},~{fpsr},~{flags}"(i32 7, i32 0) #19, !srcloc !17
...
define internal i32 @__get_cpuid_max(i32 %__level, i32* %__sig) #9 {
  %"reg2mem alloca point" = bitcast i32 0 to i32
  %1 = call { i32, i32, i32, i32 } asm "  xchgq  %rbx,${1:q}\0A  cpuid\0A  xchgq  %rbx,${1:q}", "={ax},=r,={cx},={dx},0,~{dirflag},~{fpsr},~{flags}"(i32 %__level) #19, !srcloc !18
...
define i64 @reservation_info_compare(%struct.reservation_info* nocapture readonly %aPtr, %struct.reservation_info* nocapture readonly %bPtr) #10 {
...
; Function Attrs: norecurse nounwind readonly uwtable
define i64 @reservation_compare(%struct.reservation* nocapture readonly %aPtr, %struct.reservation* nocapture readonly %bPtr) #10 {
...
; Function Attrs: norecurse nounwind readonly uwtable
define i64 @reservation_hash(%struct.reservation* nocapture readonly %reservationPtr) #10 {
...
; Function Attrs: nounwind uwtable
define internal void @freeNode.125(%struct.node* %n) #11 {
  %1 = alloca %struct.node*, align 8
...
; Function Attrs: nounwind uwtable
define internal void @TMfreeNode.126(%struct.node* %n) #11 {
  %1 = alloca %struct.node*, align 8
  store %struct.node* %n, %struct.node** %1, align 8
  %2 = load %struct.node*, %struct.node** %1, align 8
  %3 = icmp ne %struct.node* %2, null
...
; Function Attrs: inlinehint nounwind uwtable
define internal %struct.node* @parentOf(%struct.node* %n) #13 {
  %1 = alloca %struct.node*, align 8
  store %struct.node* %n, %struct.node** %1, align 8
  %2 = load %struct.node*, %struct.node** %1, align 8
  %3 = icmp ne %struct.node* %2, null
...
; Function Attrs: inlinehint nounwind uwtable
define internal %struct.node* @leftOf(%struct.node* %n) #13 {
  %1 = alloca %struct.node*, align 8
  store %struct.node* %n, %struct.node** %1, align 8
  %2 = load %struct.node*, %struct.node** %1, align 8
  %3 = icmp ne %struct.node* %2, null
...
; Function Attrs: inlinehint nounwind uwtable
define internal %struct.node* @rightOf(%struct.node* %n) #13 {
  %1 = alloca %struct.node*, align 8
  store %struct.node* %n, %struct.node** %1, align 8
  %2 = load %struct.node*, %struct.node** %1, align 8
  %3 = icmp ne %struct.node* %2, null
...
; Function Attrs: inlinehint nounwind uwtable
define internal i64 @colorOf(%struct.node* %n) #13 {
  %1 = alloca %struct.node*, align 8
  store %struct.node* %n, %struct.node** %1, align 8
  %2 = load %struct.node*, %struct.node** %1, align 8
  %3 = icmp ne %struct.node* %2, null
...
; Function Attrs: inlinehint nounwind uwtable
define internal void @setColor(%struct.node* %n, i64 %c) #13 {
  %1 = alloca %struct.node*, align 8
  %2 = alloca i64, align 8
  store %struct.node* %n, %struct.node** %1, align 8
...
; Function Attrs: inlinehint nounwind uwtable
define internal %struct.node* @TMparentOf(%struct.node* %n) #13 {
  %1 = alloca %struct.node*, align 8
  store %struct.node* %n, %struct.node** %1, align 8
  %2 = load %struct.node*, %struct.node** %1, align 8
  %3 = icmp ne %struct.node* %2, null
...
; Function Attrs: inlinehint nounwind uwtable
define internal %struct.node* @TMleftOf(%struct.node* %n) #13 {
  %1 = alloca %struct.node*, align 8
  store %struct.node* %n, %struct.node** %1, align 8
  %2 = load %struct.node*, %struct.node** %1, align 8
  %3 = icmp ne %struct.node* %2, null
...
; Function Attrs: inlinehint nounwind uwtable
define internal %struct.node* @TMrightOf(%struct.node* %n) #13 {
  %1 = alloca %struct.node*, align 8
  store %struct.node* %n, %struct.node** %1, align 8
  %2 = load %struct.node*, %struct.node** %1, align 8
  %3 = icmp ne %struct.node* %2, null
...
; Function Attrs: inlinehint nounwind uwtable
define internal i64 @TMcolorOf(%struct.node* %n) #13 {
  %1 = alloca %struct.node*, align 8
  store %struct.node* %n, %struct.node** %1, align 8
  %2 = load %struct.node*, %struct.node** %1, align 8
  %3 = icmp ne %struct.node* %2, null
...
; Function Attrs: inlinehint nounwind uwtable
define internal void @TMsetColor(%struct.node* %n, i64 %c) #13 {
  %1 = alloca %struct.node*, align 8
  %2 = alloca i64, align 8
  %3 = alloca i64, align 8
  store %struct.node* %n, %struct.node** %1, align 8
...
define void @RTM_fallback_unlock() #13 {
  call void asm sideeffect "", "~{dirflag},~{fpsr},~{flags}"() #4, !srcloc !24
  %1 = load i64*, i64** @RTM_fallBackLock, align 8
  store volatile i64 0, i64* %1, align 8
  ret void
}
...
attributes #6 = { noreturn nounwind "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+rtm,+sse,+sse2" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!15 = !{i32 -2145756178}
!16 = !{i32 -2145755630}
!17 = !{i32 -2145704887, i32 -2145704851, i32 -2145704827}
!18 = !{i32 -2145976018, i32 -2145975982, i32 -2145975958}
!19 = !{i32 -2145980187}
!20 = !{i32 -2145980085}
!21 = !{i32 -2145979915}
!22 = !{i32 -2145980288}
