...
@"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_vi" = external global i64
@"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_lsup" = external global i64
@"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_granularity" = external global i64
...
; <label>:8                                       ; preds = %0
  ...
  br label %__kernel__manager_deleteCustomer0_outer_chunking

__kernel__manager_deleteCustomer0_outer_chunking: ; preds = %8, %__kernel__manager_deleteCustomer0_exitChunk
  %lsup_value = load i64, i64* @"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_lsup"
  store i64 %lsup_value, i64* @"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_vi"
  %granularity_value = load i64, i64* @"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_granularity"
  %new_lsup = add i64 %lsup_value, %granularity_value
  store i64 %new_lsup, i64* @"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_lsup"
  %outer_vi = load i64, i64* @"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_vi"
  br label %__kernel____kernel__manager_deleteCustomer0_viCond

__kernel____kernel__manager_deleteCustomer0_viCond: ; preds = %__kernel__manager_deleteCustomer0_outer_chunking, %41
  %vi_value = phi i64 [ %outer_vi, %__kernel__manager_deleteCustomer0_outer_chunking ], [ %"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_vi_inc", %41 ]
  %lsup_value3 = load i64, i64* @"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_lsup"
  %"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_vi_cmp" = icmp slt i64 %vi_value, %lsup_value3
  br i1 %"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_vi_cmp", label %__kernel__manager_deleteCustomer0, label %__kernel__manager_deleteCustomer0_exitChunk

__kernel__manager_deleteCustomer0_exitChunk:      ; preds = %__kernel____kernel__manager_deleteCustomer0_viCond
  br label %__kernel__manager_deleteCustomer0_outer_chunking

__kernel__manager_deleteCustomer0:                ; preds = %__kernel____kernel__manager_deleteCustomer0_viCond
...
; <label>:41                                      ; preds = %._crit_edge1, %40
  ...
  %"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_vi_inc" = add i64 %vi_value, 1
  store i64 %"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_vi_inc", i64* @"../bin/manager.marked.ll_manager_deleteCustomer___kernel__manager_deleteCustomer0_vi"
  br label %__kernel____kernel__manager_deleteCustomer0_viCond, !llvm.loop !5
