...
; <label>:31                                      ; preds = %60, %14
  %32 = load %struct.list*, %struct.list** %reservationInfoListPtr, align 8
  %33 = call i64 @TMlist_iter_hasNext(%struct.list_node** %it, %struct.list* %32) #8
  %34 = icmp ne i64 %33, 0
  br i1 %34, label %35, label %62

; <label>:35                                      ; preds = %31
  %36 = load %struct.list*, %struct.list** %reservationInfoListPtr, align 8
  %37 = call i8* @TMlist_iter_next(%struct.list_node** %it, %struct.list* %36)
  %38 = bitcast i8* %37 to %struct.reservation_info*
  store %struct.reservation_info* %38, %struct.reservation_info** %reservationInfoPtr, align 8
  %39 = load %struct.reservation_info*, %struct.reservation_info** %reservationInfoPtr, align 8
  %40 = getelementptr inbounds %struct.reservation_info, %struct.reservation_info* %39, i32 0, i32 0
  %41 = load i32, i32* %40, align 8
  %42 = zext i32 %41 to i64
  %43 = getelementptr inbounds [3 x %struct.rbtree*], [3 x %struct.rbtree*]* %reservationTables, i64 0, i64 %42
  %44 = load %struct.rbtree*, %struct.rbtree** %43, align 8
  %45 = load %struct.reservation_info*, %struct.reservation_info** %reservationInfoPtr, align 8
  %46 = getelementptr inbounds %struct.reservation_info, %struct.reservation_info* %45, i32 0, i32 1
  %47 = load i64, i64* %46, align 8
  %48 = inttoptr i64 %47 to i8*
  %49 = call i8* @TMrbtree_get(%struct.rbtree* %44, i8* %48)
  %50 = bitcast i8* %49 to %struct.reservation*
  store %struct.reservation* %50, %struct.reservation** %reservationPtr, align 8
  %51 = load %struct.reservation*, %struct.reservation** %reservationPtr, align 8
  %52 = icmp eq %struct.reservation* %51, null
...
; <label>:54                                      ; preds = %53, %35
  %55 = load %struct.reservation*, %struct.reservation** %reservationPtr, align 8
  %56 = call i64 @reservation_cancel(%struct.reservation* %55)
  store i64 %56, i64* %status, align 8
  %57 = load i64, i64* %status, align 8
  %58 = icmp eq i64 %57, 0
...
; <label>:60                                      ; preds = %59, %54
  %61 = load %struct.reservation_info*, %struct.reservation_info** %reservationInfoPtr, align 8
  call void @reservation_info_free(%struct.reservation_info* %61)
  br label %31, !llvm.loop !5

; <label>:62                                      ; preds = %31
  %63 = load %struct.manager*, %struct.manager** %2, align 8
  %64 = getelementptr inbounds %struct.manager, %struct.manager* %63, i32 0, i32 3
  %65 = load %struct.rbtree*, %struct.rbtree** %64, align 8
  %66 = load i64, i64* %3, align 8
  %67 = inttoptr i64 %66 to i8*
  %68 = call i64 @TMrbtree_delete(%struct.rbtree* %65, i8* %67)
  store i64 %68, i64* %status, align 8
  %69 = load i64, i64* %status, align 8
  %70 = icmp eq i64 %69, 0
...
; <label>:72                                      ; preds = %71, %62
  %73 = load %struct.customer*, %struct.customer** %customerPtr, align 8
  call void @customer_free(%struct.customer* %73)
  store i64 1, i64* %1, align 8
  br label %74
