; ModuleID = '../bin/vacation.marked.ll'
...
; <label>:45                                      ; preds = %._crit_edge1, %44
  br label %46

; <label>:46                                      ; preds = %._crit_edge, %45
  br label %47
...
; <label>:81                                      ; preds = %._crit_edge3, %80
  br label %82

; <label>:82                                      ; preds = %._crit_edge2, %81
  br label %83
...
; <label>:7                                       ; preds = %._crit_edge6, %._crit_edge5, %._crit_edge4, %._crit_edge3, %._crit_edge2, %._crit_edge1
