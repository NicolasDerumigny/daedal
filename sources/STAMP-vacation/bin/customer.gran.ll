; ModuleID = '../bin/customer.marked.ll'
...
@"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_vi" = external global i64
@"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_lsup" = external global i64
@"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_granularity" = external global i64
...
define i64 @customer_getBill(%struct.customer* %customerPtr) #0 {
  ...
  br label %__kernel__customer_getBill0_outer_chunking

__kernel__customer_getBill0_outer_chunking:       ; preds = %0, %__kernel__customer_getBill0_exitChunk
  %bill.0 = phi i64 [ 0, %0 ], [ %bill.1, %__kernel__customer_getBill0_exitChunk ]
  %lsup_value = load i64, i64* @"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_lsup"
  store i64 %lsup_value, i64* @"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_vi"
  %granularity_value = load i64, i64* @"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_granularity"
  %new_lsup = add i64 %lsup_value, %granularity_value
  store i64 %new_lsup, i64* @"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_lsup"
  %outer_vi = load i64, i64* @"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_vi"
  br label %__kernel____kernel__customer_getBill0_viCond

__kernel____kernel__customer_getBill0_viCond:     ; preds = %__kernel__customer_getBill0_outer_chunking, %5
  %bill.1 = phi i64 [ %bill.0, %__kernel__customer_getBill0_outer_chunking ], [ %10, %5 ]
  %vi_value = phi i64 [ %outer_vi, %__kernel__customer_getBill0_outer_chunking ], [ %"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_vi_inc", %5 ]
  %lsup_value1 = load i64, i64* @"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_lsup"
  %"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_vi_cmp" = icmp slt i64 %vi_value, %lsup_value1
  br i1 %"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_vi_cmp", label %__kernel__customer_getBill0, label %__kernel__customer_getBill0_exitChunk

__kernel__customer_getBill0_exitChunk:            ; preds = %__kernel____kernel__customer_getBill0_viCond
  br label %__kernel__customer_getBill0_outer_chunking

__kernel__customer_getBill0:                      ; preds = %__kernel____kernel__customer_getBill0_viCond
  %3 = call i64 @TMlist_iter_hasNext(%struct.list_node** %it, %struct.list* %2) #7
  %4 = icmp ne i64 %3, 0
  br i1 %4, label %5, label %11

; <label>:5                                       ; preds = %__kernel__customer_getBill0
  %6 = call i8* @TMlist_iter_next(%struct.list_node** %it, %struct.list* %2)
  %7 = bitcast i8* %6 to %struct.reservation_info*
  %8 = getelementptr inbounds %struct.reservation_info, %struct.reservation_info* %7, i32 0, i32 2
  %9 = load i64, i64* %8, align 8
  %10 = add nsw i64 %bill.1, %9
  %"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_vi_inc" = add i64 %vi_value, 1
  store i64 %"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_vi_inc", i64* @"../bin/customer.marked.ll_customer_getBill___kernel__customer_getBill0_vi"
  br label %__kernel____kernel__customer_getBill0_viCond, !llvm.loop !2

; <label>:11                                      ; preds = %__kernel__customer_getBill0
  ret i64 %bill.1
}
