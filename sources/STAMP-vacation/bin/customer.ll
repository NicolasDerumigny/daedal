...
; <label>:6                                       ; preds = %10, %0
  %7 = load %struct.list*, %struct.list** %reservationInfoListPtr, align 8
  %8 = call i64 @TMlist_iter_hasNext(%struct.list_node** %it, %struct.list* %7) #7
  %9 = icmp ne i64 %8, 0
  br i1 %9, label %10, label %19

; <label>:10                                      ; preds = %6
  %11 = load %struct.list*, %struct.list** %reservationInfoListPtr, align 8
  %12 = call i8* @TMlist_iter_next(%struct.list_node** %it, %struct.list* %11)
  %13 = bitcast i8* %12 to %struct.reservation_info*
  store %struct.reservation_info* %13, %struct.reservation_info** %reservationInfoPtr, align 8
  %14 = load %struct.reservation_info*, %struct.reservation_info** %reservationInfoPtr, align 8
  %15 = getelementptr inbounds %struct.reservation_info, %struct.reservation_info* %14, i32 0, i32 2
  %16 = load i64, i64* %15, align 8
  %17 = load i64, i64* %bill, align 8
  %18 = add nsw i64 %17, %16
  store i64 %18, i64* %bill, align 8
  br label %6, !llvm.loop !2

; <label>:19                                      ; preds = %6
  %20 = load i64, i64* %bill, align 8
  ret i64 %20
}
