; ModuleID = '../bin/STAMP-vacation.tm-arg.ll'
...
; <label>:38                                      ; preds = %244, %.lr.ph31
  %i.029 = phi i64 [ 0, %.lr.ph31 ], [ %245, %244 ]
  ...
  switch i32 %action.0.i, label %243 [
    i32 0, label %46
    i32 1, label %135
    i32 2, label %164
  ]
...
; <label>:81                                      ; preds = %66
  ...
  %82 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #4
  %83 = icmp eq i64 %82, 0
...
.preheader:                                       ; preds = %84, %81, %65
  %tries.0.ph63 = phi i32 [ %tries.0.ph.lcssa62, %81 ], [ %tries.0.ph.lcssa62, %84 ], [ %tries.0.ph.lcssa, %65 ]
...
.lr.ph27:                                         ; preds = %111, %.lr.ph27.preheader
  %n.126 = phi i64 [ %112, %111 ], [ 0, %.lr.ph27.preheader ]
  %isFound.025 = phi i64 [ %isFound.1, %111 ], [ 0, %.lr.ph27.preheader ]
  %85 = getelementptr inbounds i64, i64* %23, i64 %n.126
  %86 = load i64, i64* %85, align 8
  %87 = getelementptr inbounds i64, i64* %25, i64 %n.126
...
; <label>:89                                      ; preds = %.lr.ph27
  %90 = tail call i64 @manager_queryCar(%struct.manager* %10, i64 %88) #15
  %91 = icmp sgt i64 %90, -1
  br i1 %91, label %92, label %105

; <label>:92                                      ; preds = %89
  %93 = tail call i64 @manager_queryCarPrice(%struct.manager* %10, i64 %88) #4
  br label %105

; <label>:94                                      ; preds = %.lr.ph27
  %95 = tail call i64 @manager_queryFlight(%struct.manager* %10, i64 %88) #15
  %96 = icmp sgt i64 %95, -1
  br i1 %96, label %97, label %105

; <label>:97                                      ; preds = %94
  %98 = tail call i64 @manager_queryFlightPrice(%struct.manager* %10, i64 %88) #4
  br label %105

; <label>:99                                      ; preds = %.lr.ph27
  %100 = tail call i64 @manager_queryRoom(%struct.manager* %10, i64 %88) #15
  %101 = icmp sgt i64 %100, -1
  br i1 %101, label %102, label %105

; <label>:102                                     ; preds = %99
  %103 = tail call i64 @manager_queryRoomPrice(%struct.manager* %10, i64 %88) #4
  br label %105

; <label>:104                                     ; preds = %.lr.ph27
...
; <label>:105                                     ; preds = %102, %99, %97, %94, %92, %89
  %price.0 = phi i64 [ %103, %102 ], [ -1, %99 ], [ %98, %97 ], [ -1, %94 ], [ %93, %92 ], [ -1, %89 ]
  %106 = getelementptr inbounds [3 x i64], [3 x i64]* %maxPrices, i64 0, i64 %86
  %107 = load i64, i64* %106, align 8
  %108 = icmp sgt i64 %price.0, %107
  br i1 %108, label %109, label %111

; <label>:109                                     ; preds = %105
  store i64 %price.0, i64* %106, align 8
  %110 = getelementptr inbounds [3 x i64], [3 x i64]* %maxIds, i64 0, i64 %86
  store i64 %88, i64* %110, align 8
  br label %111

; <label>:111                                     ; preds = %109, %105
  %isFound.1 = phi i64 [ 1, %109 ], [ %isFound.025, %105 ]
  %112 = add nuw nsw i64 %n.126, 1
  %113 = icmp slt i64 %112, %49
  br i1 %113, label %.lr.ph27, label %._crit_edge28, !llvm.loop !3

._crit_edge28:                                    ; preds = %111
  %isFound.1.lcssa = phi i64 [ %isFound.1, %111 ]
  %114 = icmp eq i64 %isFound.1.lcssa, 0
  br i1 %114, label %._crit_edge28.thread, label %115

; <label>:115                                     ; preds = %._crit_edge28
  %116 = tail call i64 @manager_addCustomer(%struct.manager* %10, i64 %52) #4
  br label %._crit_edge28.thread

._crit_edge28.thread:                             ; preds = %115, %._crit_edge28, %.preheader
  %117 = load i64, i64* %35, align 16
  %118 = icmp sgt i64 %117, 0
  br i1 %118, label %119, label %121

; <label>:119                                     ; preds = %._crit_edge28.thread
  %120 = tail call i64 @manager_reserveCar(%struct.manager* %10, i64 %52, i64 %117) #4
  br label %121

; <label>:121                                     ; preds = %119, %._crit_edge28.thread
  %122 = load i64, i64* %36, align 8
  %123 = icmp sgt i64 %122, 0
  br i1 %123, label %124, label %126

; <label>:124                                     ; preds = %121
  %125 = tail call i64 @manager_reserveFlight(%struct.manager* %10, i64 %52, i64 %122) #4
  br label %126

; <label>:126                                     ; preds = %124, %121
  %127 = load i64, i64* %37, align 16
  %128 = icmp sgt i64 %127, 0
  br i1 %128, label %129, label %131

; <label>:129                                     ; preds = %126
  %130 = tail call i64 @manager_reserveRoom(%struct.manager* %10, i64 %52, i64 %127) #4
  br label %131

; <label>:131                                     ; preds = %129, %126
  %132 = icmp sgt i32 %tries.0.ph63, 1
...
; <label>:135                                     ; preds = %38
  %136 = tail call i64 @random_generate(%struct.random* %12) #4
  %137 = urem i64 %136, %18
  %138 = add i64 %137, 1
  br label %.outer2

.outer2:                                          ; preds = %146, %135
  %tries3.0.ph = phi i32 [ %147, %146 ], [ 9, %135 ]
  %139 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #4
  %140 = icmp eq i64 %139, 0
  %141 = bitcast i64** @RTM_fallBackLock to i8*
  call void @llvm.prefetch(i8* %141, i32 0, i32 3, i32 1)
  br i1 %140, label %._crit_edge19, label %.lr.ph18.preheader
...
.lr.ph18:                                         ; preds = %.lr.ph18, %.lr.ph18.preheader
  tail call void @llvm.x86.sse2.pause() #4
  %142 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #4
  %143 = icmp eq i64 %142, 0
  br i1 %143, label %._crit_edge19.loopexit, label %.lr.ph18

._crit_edge19.loopexit:                           ; preds = %.lr.ph18
  br label %._crit_edge19

._crit_edge19:                                    ; preds = %._crit_edge19.loopexit, %.outer2
  %144 = icmp slt i32 %tries3.0.ph, 2
  br i1 %144, label %145, label %146

; <label>:145                                     ; preds = %._crit_edge19
  %tries3.0.ph.lcssa = phi i32 [ %tries3.0.ph, %._crit_edge19 ]
  tail call void (...) bitcast (void ()* @RTM_fallback_lock to void (...)*)() #4
  br label %155

; <label>:146                                     ; preds = %._crit_edge19
  %147 = add nsw i32 %tries3.0.ph, -1
  %148 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 1, i64 0, i64 1, i64 4294967295) #4, !srcloc !1
  %149 = trunc i64 %148 to i32
  %150 = icmp eq i32 %149, -1
  br i1 %150, label %151, label %.outer2

; <label>:151                                     ; preds = %146
  %tries3.0.ph.lcssa60 = phi i32 [ %tries3.0.ph, %146 ]
  %152 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #4
...
; <label>:155                                     ; preds = %154, %151, %145
  %tries3.0.ph61 = phi i32 [ %tries3.0.ph.lcssa60, %151 ], [ %tries3.0.ph.lcssa60, %154 ], [ %tries3.0.ph.lcssa, %145 ]
  %156 = tail call i64 @manager_queryCustomerBill(%struct.manager* %10, i64 %138) #4
  %157 = icmp sgt i64 %156, -1
  br i1 %157, label %158, label %160

; <label>:158                                     ; preds = %155
  %159 = tail call i64 @manager_deleteCustomer(%struct.manager* %10, i64 %138) #4
  br label %160

; <label>:160                                     ; preds = %158, %155
  %161 = icmp sgt i32 %tries3.0.ph61, 1
...
; <label>:164                                     ; preds = %38
  %165 = tail call i64 @random_generate(%struct.random* %12) #4
  %166 = urem i64 %165, %16
  %167 = add i64 %166, 1
  %168 = icmp sgt i64 %167, 0
  br i1 %168, label %.lr.ph.preheader, label %.outer5.preheader

.lr.ph.preheader:                                 ; preds = %164
  br label %.lr.ph

.lr.ph:                                           ; preds = %186, %.lr.ph.preheader
  %n4.013 = phi i64 [ %187, %186 ], [ 0, %.lr.ph.preheader ]
  %169 = tail call i64 @random_generate(%struct.random* %12) #4
  %170 = urem i64 %169, 3
  %171 = getelementptr inbounds i64, i64* %23, i64 %n4.013
  store i64 %170, i64* %171, align 8
  %172 = tail call i64 @random_generate(%struct.random* %12) #4
  %173 = urem i64 %172, %18
  %174 = add i64 %173, 1
  %175 = getelementptr inbounds i64, i64* %25, i64 %n4.013
  store i64 %174, i64* %175, align 8
  %176 = tail call i64 @random_generate(%struct.random* %12) #4
  %177 = and i64 %176, 1
  %178 = getelementptr inbounds i64, i64* %27, i64 %n4.013
  store i64 %177, i64* %178, align 8
  %179 = icmp eq i64 %177, 0
  br i1 %179, label %186, label %180

; <label>:180                                     ; preds = %.lr.ph
  %181 = tail call i64 @random_generate(%struct.random* %12) #4
  %182 = urem i64 %181, 5
  %183 = mul nuw nsw i64 %182, 10
  %184 = add nuw nsw i64 %183, 50
  %185 = getelementptr inbounds i64, i64* %29, i64 %n4.013
  store i64 %184, i64* %185, align 8
  br label %186

; <label>:186                                     ; preds = %180, %.lr.ph
  %187 = add nuw nsw i64 %n4.013, 1
  %exitcond = icmp eq i64 %187, %167
  br i1 %exitcond, label %.outer5.preheader.loopexit, label %.lr.ph

.outer5.preheader.loopexit:                       ; preds = %186
  br label %.outer5.preheader

.outer5.preheader:                                ; preds = %.outer5.preheader.loopexit, %164
  br label %.outer5
...
.lr.ph14:                                         ; preds = %.lr.ph14.preheader, %.lr.ph14
  ...
  br i1 %189, label %._crit_edge.loopexit, label %.lr.ph14

._crit_edge.loopexit:                             ; preds = %.lr.ph14
  br label %._crit_edge

._crit_edge:                                      ; preds = %.outer5, %._crit_edge.loopexit
  %190 = icmp slt i32 %tries6.0.ph, 2
...
; <label>:192                                     ; preds = %._crit_edge
  %193 = add nsw i32 %tries6.0.ph, -1
  %194 = tail call i64 asm sideeffect "mov $0, %rcx\0A\09mov $1, %rdx\0A\09mov $2, %rdi\0A\09xbegin   .+6 \0A\09", "={ax},r,r,r,0,~{rax},~{rcx},~{rdx},~{rdi},~{dirflag},~{fpsr},~{flags}"(i64 2, i64 0, i64 2, i64 4294967295) #4, !srcloc !1
  %195 = trunc i64 %194 to i32
  %196 = icmp eq i32 %195, -1
  br i1 %196, label %208, label %.outer5

.outer5:                                          ; preds = %192, %.outer5.preheader
  %tries6.0.ph = phi i32 [ %193, %192 ], [ 9, %.outer5.preheader ]
  %197 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #4
  %198 = icmp eq i64 %197, 0
  %199 = bitcast i64** @RTM_fallBackLock to i8*
  call void @llvm.prefetch(i8* %199, i32 0, i32 3, i32 1)
  %200 = getelementptr inbounds i64, i64* %23, i64 0
  %201 = bitcast i64* %200 to i8*
  call void @llvm.prefetch(i8* %201, i32 0, i32 3, i32 1)
  %202 = getelementptr inbounds i64, i64* %25, i64 0
  %203 = bitcast i64* %202 to i8*
  call void @llvm.prefetch(i8* %203, i32 0, i32 3, i32 1)
  %204 = getelementptr inbounds i64, i64* %27, i64 0
  %205 = bitcast i64* %204 to i8*
  call void @llvm.prefetch(i8* %205, i32 0, i32 3, i32 1)
  %206 = getelementptr inbounds i64, i64* %29, i64 0
  %207 = bitcast i64* %206 to i8*
  call void @llvm.prefetch(i8* %207, i32 0, i32 3, i32 1)
  br i1 %198, label %._crit_edge, label %.lr.ph14.preheader

.lr.ph14.preheader:                               ; preds = %.outer5
  br label %.lr.ph14

; <label>:208                                     ; preds = %192
  %tries6.0.ph.lcssa58 = phi i32 [ %tries6.0.ph, %192 ]
  %209 = tail call i64 (...) bitcast (i64 ()* @RTM_fallback_isLocked to i64 (...)*)() #4
  %210 = icmp eq i64 %209, 0
  br i1 %210, label %.preheader3, label %211

; <label>:211                                     ; preds = %208
  tail call void asm sideeffect "mov $0,%rcx\0A\09xabort  $$0 \0A\09", "r,~{rcx},~{dirflag},~{fpsr},~{flags}"(i64 255) #4, !srcloc !2
  br label %.preheader3

.preheader3:                                      ; preds = %211, %208, %191
  %tries6.0.ph59 = phi i32 [ %tries6.0.ph.lcssa58, %208 ], [ %tries6.0.ph.lcssa58, %211 ], [ %tries6.0.ph.lcssa, %191 ]
  br i1 %168, label %.lr.ph16.preheader, label %._crit_edge17

.lr.ph16.preheader:                               ; preds = %.preheader3
  br label %.lr.ph16

.lr.ph16:                                         ; preds = %237, %.lr.ph16.preheader
  %n4.115 = phi i64 [ %238, %237 ], [ 0, %.lr.ph16.preheader ]
  %212 = getelementptr inbounds i64, i64* %23, i64 %n4.115
  %213 = load i64, i64* %212, align 8
  %214 = getelementptr inbounds i64, i64* %25, i64 %n4.115
  %215 = load i64, i64* %214, align 8
  %216 = getelementptr inbounds i64, i64* %27, i64 %n4.115
  %217 = load i64, i64* %216, align 8
  %218 = icmp eq i64 %217, 0
  br i1 %218, label %229, label %219

; <label>:219                                     ; preds = %.lr.ph16
  %220 = getelementptr inbounds i64, i64* %29, i64 %n4.115
...
; <label>:222                                     ; preds = %219
  %223 = tail call i64 @manager_addCar(%struct.manager* %10, i64 %215, i64 100, i64 %221) #4
  br label %237

; <label>:224                                     ; preds = %219
  %225 = tail call i64 @manager_addFlight(%struct.manager* %10, i64 %215, i64 100, i64 %221) #4
  br label %237

; <label>:226                                     ; preds = %219
  %227 = tail call i64 @manager_addRoom(%struct.manager* %10, i64 %215, i64 100, i64 %221) #4
  br label %237
...
; <label>:229                                     ; preds = %.lr.ph16
  switch i64 %213, label %236 [
    i64 0, label %230
    i64 1, label %232
    i64 2, label %234
  ]
...
; <label>:230                                     ; preds = %229
  %231 = tail call i64 @manager_deleteCar(%struct.manager* %10, i64 %215, i64 100) #4
  br label %237

; <label>:232                                     ; preds = %229
  %233 = tail call i64 @manager_deleteFlight(%struct.manager* %10, i64 %215) #4
  br label %237

; <label>:234                                     ; preds = %229
  %235 = tail call i64 @manager_deleteRoom(%struct.manager* %10, i64 %215, i64 100) #4
  br label %237
...
; <label>:237                                     ; preds = %234, %232, %230, %226, %224, %222
  %238 = add nuw nsw i64 %n4.115, 1
  %239 = icmp slt i64 %238, %167
  br i1 %239, label %.lr.ph16, label %._crit_edge17.loopexit, !llvm.loop !6

._crit_edge17.loopexit:                           ; preds = %237
  br label %._crit_edge17

._crit_edge17:                                    ; preds = %._crit_edge17.loopexit, %.preheader3
  %240 = icmp sgt i32 %tries6.0.ph59, 1
  br i1 %240, label %241, label %242

; <label>:241                                     ; preds = %._crit_edge17
  tail call void asm sideeffect "mov $0,%rcx\0A\09xend \0A\09", "r,~{rcx},~{dirflag},~{fpsr},~{flags}"(i64 2) #4, !srcloc !5
  br label %244

; <label>:242                                     ; preds = %._crit_edge17
  tail call void (...) bitcast (void ()* @RTM_fallback_unlock to void (...)*)() #4
  br label %244
...
; <label>:244                                     ; preds = %242, %241, %163, %162, %134, %133
  tail call void @workEnd(i32 0, i32 0) #4
  %245 = add nuw nsw i64 %i.029, 1
  %246 = icmp slt i64 %245, %14
  br i1 %246, label %38, label %._crit_edge32.loopexit

._crit_edge32.loopexit:                           ; preds = %244
  br label %._crit_edge32
...
._crit_edge32:                                    ; preds = %._crit_edge32.loopexit, %.._crit_edge32_crit_edge
  ...
  %247 = tail call i64 (...) bitcast (i64 ()* @thread_getId to i64 (...)*)() #4
  %248 = trunc i64 %247 to i32
  %249 = load i32, i32* %.pre-phi, align 4
  tail call void @SimRoiEnd(i32 %248, i32 %249) #4
  ret void
}
