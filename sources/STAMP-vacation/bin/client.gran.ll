...
@"../bin/client.marked.ll_client_run___kernel__client_run0_vi" = external global i64
@"../bin/client.marked.ll_client_run___kernel__client_run0_lsup" = external global i64
@"../bin/client.marked.ll_client_run___kernel__client_run0_granularity" = external global i64
@"../bin/client.marked.ll_client_run___kernel__client_run1_vi" = external global i64
@"../bin/client.marked.ll_client_run___kernel__client_run1_lsup" = external global i64
@"../bin/client.marked.ll_client_run___kernel__client_run1_granularity" = external global i64
...
; <label>:46                                      ; preds = %282, %7
  ...
  store i64 0, i64* @"../bin/client.marked.ll_client_run___kernel__client_run0_vi"
  store i64 0, i64* @"../bin/client.marked.ll_client_run___kernel__client_run1_vi"
...
; <label>:95                                      ; preds = %94, %84
  br label %__kernel__client_run1_outer_chunking

__kernel__client_run1_outer_chunking:             ; preds = %95, %__kernel__client_run1_exitChunk
  %n.1 = phi i64 [ 0, %95 ], [ %n.2, %__kernel__client_run1_exitChunk ]
  %isFound.0 = phi i64 [ 0, %95 ], [ %isFound.1, %__kernel__client_run1_exitChunk ]
  %lsup_value14 = load i64, i64* @"../bin/client.marked.ll_client_run___kernel__client_run1_lsup"
  store i64 %lsup_value14, i64* @"../bin/client.marked.ll_client_run___kernel__client_run1_vi"
  %granularity_value15 = load i64, i64* @"../bin/client.marked.ll_client_run___kernel__client_run1_granularity"
  %new_lsup16 = add i64 %lsup_value14, %granularity_value15
  store i64 %new_lsup16, i64* @"../bin/client.marked.ll_client_run___kernel__client_run1_lsup"
  %outer_vi17 = load i64, i64* @"../bin/client.marked.ll_client_run___kernel__client_run1_vi"
  br label %__kernel____kernel__client_run1_viCond

__kernel____kernel__client_run1_viCond:           ; preds = %__kernel__client_run1_outer_chunking, %129
  %n.2 = phi i64 [ %n.1, %__kernel__client_run1_outer_chunking ], [ %130, %129 ]
  %isFound.1 = phi i64 [ %isFound.0, %__kernel__client_run1_outer_chunking ], [ %isFound.2, %129 ]
  %vi_value18 = phi i64 [ %outer_vi17, %__kernel__client_run1_outer_chunking ], [ %"../bin/client.marked.ll_client_run___kernel__client_run1_vi_inc", %129 ]
  %lsup_value19 = load i64, i64* @"../bin/client.marked.ll_client_run___kernel__client_run1_lsup"
  %"../bin/client.marked.ll_client_run___kernel__client_run1_vi_cmp" = icmp slt i64 %vi_value18, %lsup_value19
  br i1 %"../bin/client.marked.ll_client_run___kernel__client_run1_vi_cmp", label %__kernel__client_run1, label %__kernel__client_run1_exitChunk

__kernel__client_run1_exitChunk:                  ; preds = %__kernel____kernel__client_run1_viCond
  br label %__kernel__client_run1_outer_chunking

__kernel__client_run1:                            ; preds = %__kernel____kernel__client_run1_viCond
  %96 = icmp slt i64 %n.2, %59
  br i1 %96, label %97, label %131

; <label>:97                                      ; preds = %__kernel__client_run1
  %98 = getelementptr inbounds i64, i64* %26, i64 %n.2
  %99 = load i64, i64* %98, align 8
  %100 = getelementptr inbounds i64, i64* %29, i64 %n.2
...
; <label>:128                                     ; preds = %._crit_edge4, %125
  %isFound.2 = phi i64 [ 1, %125 ], [ %isFound.1, %._crit_edge4 ]
  br label %129

; <label>:129                                     ; preds = %128
  %130 = add nsw i64 %n.2, 1
  %"../bin/client.marked.ll_client_run___kernel__client_run1_vi_inc" = add i64 %vi_value18, 1
  store i64 %"../bin/client.marked.ll_client_run___kernel__client_run1_vi_inc", i64* @"../bin/client.marked.ll_client_run___kernel__client_run1_vi"
  br label %__kernel____kernel__client_run1_viCond, !llvm.loop !3

; <label>:131                                     ; preds = %__kernel__client_run1
  %132 = icmp ne i64 %isFound.1, 0
...
; <label>:240                                     ; preds = %239, %229
  br label %__kernel__client_run0_outer_chunking

__kernel__client_run0_outer_chunking:             ; preds = %240, %__kernel__client_run0_exitChunk
  %n4.1 = phi i64 [ 0, %240 ], [ %n4.2, %__kernel__client_run0_exitChunk ]
  %lsup_value = load i64, i64* @"../bin/client.marked.ll_client_run___kernel__client_run0_lsup"
  store i64 %lsup_value, i64* @"../bin/client.marked.ll_client_run___kernel__client_run0_vi"
  %granularity_value = load i64, i64* @"../bin/client.marked.ll_client_run___kernel__client_run0_granularity"
  %new_lsup = add i64 %lsup_value, %granularity_value
  store i64 %new_lsup, i64* @"../bin/client.marked.ll_client_run___kernel__client_run0_lsup"
  %outer_vi = load i64, i64* @"../bin/client.marked.ll_client_run___kernel__client_run0_vi"
  br label %__kernel____kernel__client_run0_viCond

__kernel____kernel__client_run0_viCond:           ; preds = %__kernel__client_run0_outer_chunking, %271
  %n4.2 = phi i64 [ %n4.1, %__kernel__client_run0_outer_chunking ], [ %272, %271 ]
  %vi_value = phi i64 [ %outer_vi, %__kernel__client_run0_outer_chunking ], [ %"../bin/client.marked.ll_client_run___kernel__client_run0_vi_inc", %271 ]
  %lsup_value13 = load i64, i64* @"../bin/client.marked.ll_client_run___kernel__client_run0_lsup"
  %"../bin/client.marked.ll_client_run___kernel__client_run0_vi_cmp" = icmp slt i64 %vi_value, %lsup_value13
  br i1 %"../bin/client.marked.ll_client_run___kernel__client_run0_vi_cmp", label %__kernel__client_run0, label %__kernel__client_run0_exitChunk

__kernel__client_run0_exitChunk:                  ; preds = %__kernel____kernel__client_run0_viCond
  br label %__kernel__client_run0_outer_chunking

__kernel__client_run0:                            ; preds = %__kernel____kernel__client_run0_viCond
  %241 = icmp slt i64 %n4.2, %194
  br i1 %241, label %242, label %273

; <label>:242                                     ; preds = %__kernel__client_run0
  %243 = getelementptr inbounds i64, i64* %26, i64 %n4.2
  %244 = load i64, i64* %243, align 8
  %245 = getelementptr inbounds i64, i64* %29, i64 %n4.2
  %246 = load i64, i64* %245, align 8
  %247 = getelementptr inbounds i64, i64* %32, i64 %n4.2
  %248 = load i64, i64* %247, align 8
  %249 = icmp ne i64 %248, 0
  br i1 %249, label %250, label %261

; <label>:250                                     ; preds = %242
  %251 = getelementptr inbounds i64, i64* %35, i64 %n4.2
...
; <label>:271                                     ; preds = %270
  %272 = add nsw i64 %n4.2, 1
  %"../bin/client.marked.ll_client_run___kernel__client_run0_vi_inc" = add i64 %vi_value, 1
  store i64 %"../bin/client.marked.ll_client_run___kernel__client_run0_vi_inc", i64* @"../bin/client.marked.ll_client_run___kernel__client_run0_vi"
  br label %__kernel____kernel__client_run0_viCond, !llvm.loop !6
